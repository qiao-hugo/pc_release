...
class Vtiger_Language_Handler {
	...
	public static function getModuleStringsFromFile($language, $module='Vtiger'){
	   ...
	   if(empty($module)){
		...
		return !empty(self::$languageContainer[$language][$module])?self::$languageContainer[$language][$module]:array();
	}
	...
	public static function getLanguage() {
		...
		return empty($current_language)? vglobal('default_language') : $current_language;
	}
