...
<div class="popupEntriesDiv" id="listViewContents">
	...
	<table class="table table-bordered listViewEntriesTable">
        ...
        {foreach item=LISTVIEW_ENTRY from=$LISTVIEW_ENTRIES name=popupListView}
            <tr class="listViewEntries" data-id="{$LISTVIEW_ENTRY['id']}" data-name="{$LISTVIEW_ENTRY['encodingrulename']}"  data-info='{ZEND_JSON::encode($LISTVIEW_ENTRY)}'
                ...
                {foreach key=KEY item=LISTVIEW_HEADER from=$LISTVIEW_HEADERS}
                    ...
                    <td class="listViewEntryValue {$WIDTHTYPE}">
							...
							{if $LISTVIEW_HEADER eq 'serviceid'}
							{uitypeformat(54,$LISTVIEW_ENTRY[$LISTVIEW_HEADER],$MODULE)}
							{else}
