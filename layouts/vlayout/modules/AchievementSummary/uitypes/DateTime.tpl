...
{strip}
	...
	<div class="input-append row-fluid">
		...
		<span class="add-on clearDate cursorPointer">
			...
			<input id="{$MODULE}_editView_fieldName_{$FIELD_NAME}" type="text" class="span9 dateField1 {$FIELD_MODEL->getFieldName()}" name="{$FIELD_MODEL->getFieldName()}" data-date-format="{$dateFormat} hh:ii:00"
