	...
	<table class="table table-bordered blockContainer showInlineTable  detailview-table" id = "fallintotable">
        ...
        <tr >
            ...
            <td>
				...
				<a target="_blank"  href="index.php?module=Schoolpracticalpeople&view=Edit&record={$VO['schoolpracticalpeopleid']}"  target="_block"><i title="{vtranslate('LBL_EDIT', $MODULE)}" class="icon-pencil alignMiddle"></i></a>&nbsp;
            </td>
        </tr>
        {/foreach}
        </tbody>
