		...
		<table style="margin-left: auto;margin-right: auto;width: 100%;" class="searchUIBasic" cellspacing="12">
			<tr>
				<td class="font-x-large" align="left" colspan="2">
					<strong>{'LBL_IMPORT'|@vtranslate:$MODULE} 电话量 </strong>
				</td>
			</tr>
			...
			<tr>
				...
				{include file='Import_Step1.tpl'|@vtemplate_path:'TelStatistics'}
				</td>
				<td class="leftFormBorder1 importContents" width="40%" valign="top">
				{include file='Import_Step2.tpl'|@vtemplate_path:'TelStatistics'}
				</td>
			</tr>
			...
			<tr>
				...
				{include file='Import_Basic_Buttons.tpl'|@vtemplate_path:'TelStatistics'}
				</td>
			</tr>
		</table>
	</form>
