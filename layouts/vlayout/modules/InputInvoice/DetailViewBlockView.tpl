...
{strip}
    {foreach key=BLOCK_LABEL_KEY item=FIELD_MODEL_LIST from=$RECORD_STRUCTURE}
        ...
        {assign var=BILLPROPERTY value=$BILLPROPERTY}
        <input type="hidden" name='discountcoupon' id="discountcoupon" value="{$DISCOUNTCOUPONBOOL}"/>
        <table class="table table-bordered equalSplit detailview-table">
            ...
            <tr>
                ...
                {if !$FIELD_MODEL->isViewableInDetailView()}
                    {continue}
                {/if}
                {$FIELD_MODEL->get('billproperty')}
                {if (in_array($FIELD_NAME,array('smownerid'))&& $BILLPROPERTY=='BeforeHandSub')
                or  (in_array($FIELD_NAME,array('subamount','applicationno'))&& $BILLPROPERTY=='AfterHandSub')}
                    {continue}
                {/if}
    ...
    {/if}
    {if empty($DISCOUNTCOUPON) or $DISCOUNTCOUPONBOOL}
    <table class="table table-bordered blockContainer showInlineTable discountCouponDis" style="display: none">
        <tbody>
        <tr>
            <th class="blockHeader" colspan="4">抵扣联信息<span class="btn saveDeductMessage" style="display:none;float: right;background-color: #00b3ee;color: white;border: 1px solid #00b3ee;">保存</span></th>
        </tr>
        <tr>
            <td class="fieldLabel medium"><label class="muted pull-right marginRight10px"> <span class="redColor">*</span>
                    销售方名称</label></td>
            <td class="fieldValue medium" colspan="3">
                <input type="text" onfocus="initDiscountBool()" class="discountcheck" name="salename" style="width: 75%" value="{$DISCOUNTCOUPON['salename']}">
            </td>
        </tr>
        <tr>
            <td class="fieldLabel medium"><label class="muted pull-right marginRight10px"> <span class="redColor">*</span>
                    购买方名称</label></td>
            <td class="fieldValue medium" colspan="3">
                <input type="text" onfocus="initDiscountBool()"  class="discountcheck" name="buyername" style="width: 75%" value="{$DISCOUNTCOUPON['buyername']}">
            </td>
        </tr>
        <tr>
            <td class="fieldLabel medium"><label class="muted pull-right marginRight10px"> <span class="redColor">*</span>
            ...
            <td class="fieldValue medium">
                <div class="row-fluid"><span class="span10"><input type="text" onfocus="initDiscountBool()"  class="discountcheck" name="invoicecode" value="{$DISCOUNTCOUPON['invoicecode']}"></span>
                </div>
            </td>
            <td class="fieldLabel medium"><label class="muted pull-right marginRight10px"> <span class="redColor">*</span>
                    发票号码</label></td>
            <td class="fieldValue medium">
                <div class="row-fluid"><span class="span10"><input type="text" onfocus="initDiscountBool()"  class="discountcheck" name="invoiceno" value="{$DISCOUNTCOUPON['invoiceno']}"></span>
                </div>
            </td>
        </tr>
        <tr>
            <td class="fieldLabel medium"><label class="muted pull-right marginRight10px"> <span class="redColor">*</span>
                    货物或应税劳务服务名称</label></td>
            <td class="fieldValue medium">
                <div class="row-fluid"><span class="span10"><input type="text" onfocus="initDiscountBool()" class="discountcheck" name="servicename" value="{$DISCOUNTCOUPON['servicename']}"></span>
                </div>
            </td>
            <td class="fieldLabel medium"><label class="muted pull-right marginRight10px"> <span class="redColor">*</span>
                    金额</label></td>
            <td class="fieldValue medium">
                <div class="row-fluid"><span class="span10"><input type="text" onfocus="initDiscountBool()" class="discountcheck" name="amount" value="{$DISCOUNTCOUPON['amount']}"></span>
                </div>
            </td>
        </tr>
        <tr>
            <td class="fieldLabel medium"><label class="muted pull-right marginRight10px"> <span class="redColor">*</span>
                    税率</label></td>
            <td class="fieldValue medium">
                <div class="row-fluid"><span class="span10"><input type="text" onfocus="initDiscountBool()" class="discountcheck" name="taxrate" value="{$DISCOUNTCOUPON['taxrate']}"></span>
                </div>
            </td>
            <td class="fieldLabel medium"><label class="muted pull-right marginRight10px"> <span class="redColor">*</span>
                    税额</label></td>
            <td class="fieldValue medium">
                <div class="row-fluid"><span class="span10"><input type="text" onfocus="initDiscountBool()" class="discountcheck" name="taxamount" value="{$DISCOUNTCOUPON['taxamount']}"></span>
                </div>
            </td>
        </tr>
        <tr>
            <td class="fieldLabel medium"><label class="muted pull-right marginRight10px"> <span class="redColor">*</span>
                    价税合计</label></td>
            <td class="fieldValue medium">
                <div class="row-fluid"><span class="span10"><input type="text" onfocus="initDiscountBool()" class="discountcheck" name="totalpricetax" value="{$DISCOUNTCOUPON['totalpricetax']}"></span>
                </div>
            </td>
