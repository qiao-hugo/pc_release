...
<br>
	...
	<script type="text/javascript">
        ...
        $(function () {
            var stagerecordname = $("#stagerecordname").val();
            var discountcoupon = parseInt($("#discountcoupon").val());
            console.log(discountcoupon);
            if(stagerecordname=='对应会计录入抵扣联信息' && !discountcoupon  || discountcoupon ){

                $(".discountCouponDis").show();
                if(stagerecordname!='对应会计录入抵扣联信息' && discountcoupon){
                    $(".discountcheck").each(function (k, v) {
                        $(v).attr("readonly","readonly");
                    })
                }else{
                    $(".saveDeductMessage").show();
                }
            }
        })
</script>
