...
jQuery.Class("Settings_Vtiger_Performance_Js",{},{
	...
	getContainer : function() {
		if(this.container == false){
			this.container = jQuery('#PerformanceContainer').find('.contents');
		}
	...
	registerKeyUpEvent : function() {
		...
		container.one('keyup', '.performanceContent', function(e) {
			jQuery('.savePerformance', container).removeClass('hide');
		});
	},
	...
	registerEvents: function() {
		...
		var textAreaElement = jQuery('.performanceContent', container);
		var saveButton = jQuery('.savePerformance', container);
...
jQuery(document).ready(function(e){
	var instance = new Settings_Vtiger_Performance_Js();
