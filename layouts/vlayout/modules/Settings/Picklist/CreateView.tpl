...
-->*}
{strip}
<div class='modelContainer modal' style="max-width:500px;margin:30px  auto">
	...
	<form name="addItemForm" class="form-horizontal" method="post" action="index.php" style="background-color: #fff;">
