    ...
    <div>
        ...
        <form method="post"  name="SearchBug" id="SearchBug">
            ...
            <div id="SearchBlankCover" style="background-color: #F0F0F0;">
                ...
                {include file='../ReceivedPaymentsNotes/SearchJSUnbound.tpl'|@vtemplate_path MODULE=$MODULE}
        </form>
    </div>
    {include file='../ReceivedPaymentsNotes/DefaultListFieldsUnbound.tpl'|@vtemplate_path MODULE=$MODULE ISDEFAULT=false ISPAGE=true}
{/if}
