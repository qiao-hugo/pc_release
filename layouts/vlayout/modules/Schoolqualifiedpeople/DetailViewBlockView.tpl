...
{strip}
	...
	<table class="table table-bordered equalSplit detailview-table">
		...
		<tr>
			<td class="fieldLabel medium" id="Schoolqualifiedpeople_detailView_fieldLabel_createdtime">
				<label class="muted pull-right marginRight10px">姓名</label>
			</td>
			<td class="fieldValue medium" id="Schoolqualifiedpeople_detailView_fieldValue_createdtime">
				<span class="value" data-field-type="datetime">
			{$SCHOOL_RESUME.name}
				</span>
			</td>
			<td class="fieldLabel medium" id="Schoolqualifiedpeople_detailView_fieldLabel_modifiedtime">
				<label class="muted pull-right marginRight10px">性别</label>
			</td>
			<td class="fieldValue medium" id="Schoolqualifiedpeople_detailView_fieldValue_modifiedtime">
				<span class="value" data-field-type="datetime">
			{$SCHOOL_RESUME.gendertype}
				</span>
			</td>
		</tr>
		<tr>
			<td class="fieldLabel medium" id="Schoolqualifiedpeople_detailView_fieldLabel_createdtime">
				<label class="muted pull-right marginRight10px">电话</label>
			</td>
			<td class="fieldValue medium" id="Schoolqualifiedpeople_detailView_fieldValue_createdtime">
				<span class="value" data-field-type="datetime">
			{$SCHOOL_RESUME.telephone}
				</span>
			</td>
			<td class="fieldLabel medium" id="Schoolqualifiedpeople_detailView_fieldLabel_modifiedtime">
				<label class="muted pull-right marginRight10px">邮箱</label>
			</td>
			<td class="fieldValue medium" id="Schoolqualifiedpeople_detailView_fieldValue_modifiedtime">
				<span class="value" data-field-type="datetime">
			{$SCHOOL_RESUME.email}
	...
	{*
	<!-- <div id="accessible_users"><select class="chzn-select" name=""><optgroup label={vtranslate("LBL_USERS")}>{foreach key=OWNER_ID item=OWNER_NAME from=$ACCESSIBLE_USERS}<option value="{$OWNER_ID}" data-picklistvalue="{$OWNER_ID}">{$OWNER_NAME}</option>{/foreach}</optgroup></select>
    </div> -->*}
	...
	<table class="table table-bordered equalSplit detailview-table">
		...
		<tr>
				<th class="blockHeader" colspan="4">
					{$FIELD_MODEL.visitsigntype} {$FIELD_MODEL.last_name}签到
				</th>
		</tr>
		</thead>
		 <tbody>

		 {foreach item=vo from=$FIELD_MODEL.data}
		<tr>
			<td class="fieldLabel">
				<label class='muted pull-right marginRight10px'>第{$vo.signnum}次签到地点</label>
			</td>
			<td class="fieldValue">
			 	<span class="value">
					{$vo.signaddress}
			...
			<td class="fieldLabel">
				<label class='muted pull-right marginRight10px'>第{$vo.signnum}次签到时间</label>
			</td>
			<td class="fieldValue">
			 	<span class="value">
					{$vo.signtime}
