...
{strip}
	...
	{/foreach}
        ...
        <table class="table table-bordered equalSplit detailview-table ">
            ...
            <tbody>
            <tr>
                {foreach key=row_no item=data from=$PRODUCTSELECT name=PRODUCTLIST}
                ...
                <td class="fieldValue medium"  >
                    <label style="width:50%;height:100%;display: inline-block;">{vtranslate($data,'TyunUpgradeRule')}</label>
                </td>
