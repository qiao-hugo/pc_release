...
<div class="listViewEntriesDiv contents-bottomscroll" style="overflow:auto;">
	...
	<table class="table listViewEntriesTable">
		...
		<tr class="listViewEntries"  data-id='{$LISTVIEW_ENTRY['id']}' data-recordUrl='index.php?module={$MODULE}&view=Detail&record={$LISTVIEW_ENTRY['id']}&source_record={$LISTVIEW_ENTRY['autoworkflowid']}' id="{$MODULE}_listView_row_{$smarty.foreach.listview.index+1}">
            ...
            <td class="listViewEntryValue" >
                {if $LISTVIEW_HEADER@last}
                    <div  style="width:90px">
                        <a href="index.php?module={$MODULE}&view=Detail&record={$LISTVIEW_ENTRY['id']}&source_record={$LISTVIEW_ENTRY['autoworkflowid']}"><i title="详细信息" class="icon-th-list alignMiddle"></i></a>&nbsp;
                    </div>
                {/if}
            </td>
		</tr>
