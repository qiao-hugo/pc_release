...
<div class="widgetContainer_workflows" data-url="module={$ModuleName}&amp;view=Detail&amp;record={$RECORD->getId()}&amp;mode=getSoundAComments&amp;page=1&amp;limit=5" data-name="SalesorderWorkflowStages">
