...
<div class='container-fluid editViewContainer'>
	    ...
	    {if $RECORD_ID > 0 }
			<table class="table table-bordered blockContainer showInlineTable plusTableContent" data-num="yesreplace">
				...
				{foreach  key=key item=FIELD  from=$DETAIL_INFO_LIST  }
					<tr  data-id="{$FIELD['productprovide_detail_id']}"  data-idaccount="{$FIELD['idaccount']}" data-accountzh="{$FIELD['accountzh']}"  ><input type="hidden"  name="productprovide_detail_id[]"  value="{$FIELD['productprovide_detail_id']}" /><input type="hidden"  name="updateStatus[]" id="updateStatus"  value="0" />
						<td class="fieldLabel medium">
						...
						<td class="fieldValue medium">
							<input id="oldaccountzh" type="hidden" class="input-large"  name="oldaccountzh[]" value="{$FIELD['accountzh']}" >
							<input id="accountzh" type="text" class="input-large accountzh" data-validation-engine="validate[ funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" name="accountzh[]" value="{$FIELD['accountzh']}" ><a class="deleteRecordButton"><i title="删除" class="icon-trash alignMiddle"></i></a>
						</td>
					</tr>
		        {/foreach}
				</tbody>
	...
	{else}
		<table class="table table-bordered  blockContainer showInlineTable plusTableContent" data-num="yesreplace">
			...
			<tr>
				<input type="hidden"  name="productprovide_detail_id[]"  value="0" /><input type="hidden"  name="updateStatus[]" id="updateStatus" value="0" />
				<td class="fieldLabel medium">
					<label class="muted pull-right marginRight10px"><span class="redColor">*</span></label>
					</td>
				<td class="fieldValue medium">
				...
				<td class="fieldValue medium">
					<input id="accountzh" type="text" class="input-large accountzh" data-validation-engine="validate[ funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" name="accountzh[]"  placeholder="请输入账户名称" value="" ><a class="deleteRecordButton"><i title="删除" class="icon-trash alignMiddle"></i></a>
					</td>
			</tr>
			</tbody>
		</table>
	...
	<literal>
		<script>
            var appendAccountDetail ='<tr><input type="hidden"  name="productprovide_detail_id[]"  value="0" /><input type="hidden"  name="updateStatus[]" id="updateStatus" value="0" />' +
                '<td class="fieldLabel medium">' +
                '<label class="muted pull-right marginRight10px"><span class="redColor">*</span></label>' +
                '</td>' +
                '<td class="fieldValue medium">' +
