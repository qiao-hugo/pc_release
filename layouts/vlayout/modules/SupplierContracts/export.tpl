{strip}
    <form action="index.php?module=SupplierContracts&view=List&public=ExportRID" method="post">
    <table class="table table-bordered equalSplit detailview-table"><thead>
        <th colspan="2">采购/费用合同导出</th></thead><tbody>
        ...
        <tr><td style="text-align: right">选择时间
                ...
                <label class="pull-left">
                    <input type="radio" name="timeselected" value="2" checked>归还时间
                </label>
            </td></tr>
