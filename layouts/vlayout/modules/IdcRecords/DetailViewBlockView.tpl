...
{strip}
	...
	<table class="table table-bordered equalSplit detailview-table {if $BLOCK_LABEL_KEY eq 'LBL_IDCRECORDS_INFORMATION' && $IDCRECORDS_TYPE eq 'LBL_ROREGIN_AIDCTYPE'} hide tableadv{/if}" >
		<thead>
		<tr>
