...
<div class="listViewEntriesDiv contents-bottomscroll" style="overflow:auto;">
	...
	<table class="table listViewEntriesTable">
		...
		<tr class="listViewEntries"  data-id='{$LISTVIEW_ENTRY['receivedpaymentsid']}' data-recordUrl='index.php?module=ReceivedPayments&view=Detail&record={$LISTVIEW_ENTRY['receivedpaymentsid']}' id="ReceivedPayments_listView_row_{$smarty.foreach.listview.index+1}">
