{strip}
    ...
    <form action="index.php?module=ReceivedPayments&view=List&public=ExportRDALL" method="post">
        <th colspan="2"><h4>充值申请单审核设置</h4></th></thead><tbody>
        ...
        <tr><td style="text-align: right">第二次审核人
            </td><td>
                <label class="pull-left">
        ...
        <tr><td style="text-align: right">第三次审核人
            </td><td>
                <label class="pull-left">
    ...
    <script>
        ...
        $(function(){
            $('#preview').click(function(){
                ...
                params['auditsettingtype'] = "RefillApplication";
