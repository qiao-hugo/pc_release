{strip}
    <form action="index.php?module=RefillApplication&action=BasicAjax&mode=refillDetailExportData" method="post">
   <!-- <form action="index.php?module=RefillApplication&view=List&public=refillDetailExportData" method="post">-->
    <table class="table table-bordered equalSplit detailview-table"><thead>
        ...
        <th colspan="2"><h4>充值申请单明细导出</h4></th></thead><tbody>
        <tr><td style="text-align: right"><span class="redColor">*</span>完成时间
            </td><td>
