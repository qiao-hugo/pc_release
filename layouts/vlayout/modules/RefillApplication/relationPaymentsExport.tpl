{strip}
    <form action="index.php?module=RefillApplication&action=BasicAjax&mode=relationPaymentsData" method="post">
   <!-- <form action="index.php?module=RefillApplication&view=List&public=refillDetailExportData" method="post">-->
    <table class="table table-bordered equalSplit detailview-table"><thead>
        ...
        <th colspan="2"><h4>回款充值申请单关联导出</h4></th></thead><tbody>
        <tr><td style="text-align: right"><span class="redColor">*</span>匹配日期
            </td><td>
