{strip}
    <form action="index.php?module=RefillApplication&action=BasicAjax&mode=hcDetailsExport" method="post">
    <table class="table table-bordered equalSplit detailview-table"><thead>

        <th colspan="2"><h4>红冲明细导出</h4></th></thead><tbody>
        <tr><td style="text-align: right"><span class="redColor">*</span>红冲日期 
            </td><td>
