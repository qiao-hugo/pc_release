...
<button name="next" class="create btn"
	   onclick="location.href='/index.php?module=Schoolresume&view=Import'" ><strong>{'LBL_IMPORT_MORE'|@vtranslate:$MODULE}</strong></button>
&nbsp;&nbsp;
{*
...
<button name="next" class="delete btn"
		onclick="location.href='../../../../index.php'"><strong>{'LBL_UNDO_LAST_IMPORT'|@vtranslate:$MODULE}</strong></button>
&nbsp;&nbsp;
{/if}*}
<button name="cancel" class="edit btn btn-success"
		onclick="location.href='/index.php?module=Schoolresume&view=List'"><strong>{'LBL_FINISH_BUTTON_LABEL'|@vtranslate:$MODULE}</strong></button>