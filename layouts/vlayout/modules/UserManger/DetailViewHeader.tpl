...
{strip}
	...
	<input type=hidden name="userstatus" value='{$RECORD->get('status')}' />
	<input type=hidden name="isdimission" value='{$RECORD->get('isdimission')}' />
	<input type=hidden name="leavedate" value='{$RECORD->get('leavedate')}' />
