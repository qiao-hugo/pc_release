...
var Vtiger_CustomView_Js = {
	...
	loadFilterView : function(url) {
		...
		AppConnector.request(url).then(
			function(data){
				...
				//jQuery('#loadingListViewModal').css('display','none');
			
				var contents = jQuery("#showSearch").html(data);
	...
	loadFilterViewa:function(){
				var html = $("#showSearch").html();
				var contents=$("#showSearch").html(html);
				Vtiger_CustomView_Js.registerEvents();
