                            ...
                            {foreach key=fkey item=LISTVIEW_HEADER from=$LISTVIEW_HEADERS name=fieldview}
                                <td class="listViewEntryValue"  nowrap>
                                    ...
                                    {elseif $LISTVIEW_HEADER['columnname'] eq 'contractid'}
                                        <a class="btn-link" href='index.php?module=ServiceContracts&view=Detail&record={$LISTVIEW_ENTRY['contractid_reference']}' target="_block">{$LISTVIEW_ENTRY[$LISTVIEW_HEADER['columnname']]}</a>
