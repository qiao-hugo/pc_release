        ...
        <tbody class="scoremodel_tab">
        	<tr>
        		<td class="fieldValue medium t_td" style="text-align: center;">
                    <div class="row-fluid">
                        <span class="span10">
                        	<b class="t_b">参数名称  <span class="scorepara_item_mark redColor"></span></b>
                        </span>
                    </div>
                </td>
                <td class="fieldValue medium t_td">
                    <div class="row-fluid">
                        <span class="span10">
                        	<b class="t_b">参数说明 <span class="scorepara_lower_mark redColor"></span></b>
                        </span>
                    </div>
                </td>
                <td class="fieldValue medium t_td">
                    <div class="row-fluid">
                        <span class="span10">
                        	<b class="t_b">权重 <span class="scorepara_upper_mark redColor"></span></b>
                        </span>
                    </div>
                </td>
                
        	</tr>
        	{foreach from=$SCOREMODELCONTENT item=S}
