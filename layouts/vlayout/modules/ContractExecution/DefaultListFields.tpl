{strip}
    <div class="row" style="padding: 10px 20px 0 20px;">
         <span class="span4">
			{if Users_Privileges_Model::isPermitted("ContractExecution", 'EditView')}
                <button id="add_contract_execution_node" class="btn addButton"><strong>添加合同执行节点</strong></button>
