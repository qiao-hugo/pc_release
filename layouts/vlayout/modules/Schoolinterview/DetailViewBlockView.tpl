...
{strip}
	...
	<table class="table table-bordered blockContainer showInlineTable  detailview-table" id = "fallintotable">
        ...
        <tr >
            ...
            <td>{$VO['instructor']}</td>
            <td>
            	<a  href="index.php?module=Schoolresume&view=Detail&record={$VO['schoolresumeid']}"><i title="详细信息" class="icon-th-list alignMiddle"></i></a>&nbsp;

				<a  href="index.php?module=Schooladoptpeople&view=Edit&record={$VO['schooladoptpeopleid']}"  target="_block"><i title="{vtranslate('LBL_EDIT', $MODULE)}" class="icon-pencil alignMiddle"></i></a>&nbsp;
            </td>
        </tr>
        {/foreach}
        </tbody>
