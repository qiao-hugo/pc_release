                ...
                <label class="pull-left">
                    <select id="modulename" class="chzn-select referenceModulesList streched">
                        {foreach from=$ModuleName item=SMODULE}
                            <option value="{$SMODULE['module']}" {if $SMODULE['module'] eq 'ServiceContracts'} selected{/if}>{vtranslate({$SMODULE['module']})}</option>
                        {/foreach}
                    </select>
                </label>
            ...
            <tr><td style="text-align: right"><span class="redColor">*</span>可设置
                ...
                <label class="pull-left">
                    <select id="classname" class="chzn-select referenceModulesList streched" multiple>
                        {*{foreach key=index item=values from=$CLASSNAME}
                            <option value="{$values.mode}">{$values.modename}</option>
                        {/foreach}*}
                    </select>
                </label>
            </td></tr>
