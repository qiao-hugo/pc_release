{strip}
    <form action="index.php?module=ServiceContracts&view=List&public=ExportRIVD" method="post">
    <table class="table table-bordered equalSplit detailview-table"><thead>
        <th colspan="2">合同审查导出</th></thead><tbody>
        ...
        <tr><td style="text-align: right">发放时间
            </td><td>
