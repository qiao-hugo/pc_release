{strip}
    <form action="index.php?module=ServiceContracts&view=List&public=OrderCancelExportD" method="post">
    <table class="table table-bordered equalSplit detailview-table"><thead>
        <th colspan="2">作废工单导出</th></thead><tbody>
        ...
        <tr><td style="text-align: right">时间
            </td><td>
