...
<div class="input-append row-fluid">
	<div class="span10 row-fluid date form_datetime">
		...
		<input id="{$MODULE}_editView_fieldName_{$FIELD_NAME}" type="text" class="span9{if !in_array($FIELD_NAME,array('Receivedate','signdate','Returndate'))} dateField{else} customDateField{/if}" name="{$FIELD_MODEL->getFieldName()}" data-date-format="{$dateFormat}"
