{strip}
    <form action="index.php?module=ServiceContracts&view=List&public=ExportCompleteD" method="post">
    <table class="table table-bordered equalSplit detailview-table"><thead>
        <th colspan="2">发票,合同导出</th></thead><tbody>
        <tr><td style="text-align: right">签订人所在部门
            </td><td>
        ...
        <tr><td style="text-align: right">归还时间
            </td><td>
