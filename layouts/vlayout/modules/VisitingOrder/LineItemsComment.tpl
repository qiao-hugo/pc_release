{strip}
   {if !empty($CURRENTCOMMENT['visitaccountcontract'])}
    ...
    <div class="hiddensc {if !empty($CURRENTCOMMENT['visitimprovement'])}span6{else}span12{/if}" style="margin:5px;background-color:#ffffff">
        <div class="accordion-group">
            <div class="accordion-heading">
                <h4 style="margin-left:20px;">音频点评</h4>
            </div>
            <div>
                <div  class="accordion-body collapse in">
                    <div class="accordion-inner">
                        {foreach item=VISITACCOUNTCONTRACT from=$CURRENTCOMMENT['visitaccountcontract']}
                                                ...
                                                <div class="span11 commentorInfo">
                                                    <div class="inner">
                                                        <span class="commentorName">
                                                            <strong><span class="label label-a_normal">{$VISITACCOUNTCONTRACT['basic']['name']}</span></strong>
                                                        </span>
                                                    ...
                                                    <div class="commentInfoContent">
                                                        ...
                                                        <table class="table table-bordered blockContainer showInlineTable" id="achievementallottable" border="1">
                                                            <thead><tr><th class="blockHeader" nowrap><span>音频类型</span></th><th class="blockHeader" nowrap><span>点评结果</span></th><th class="blockHeader" nowrap><span>备注</span></th><th class="blockHeader" nowrap><span>点评时间</span></th></tr></thead>
                                                            <tbody>
                                                            {assign var=TEMPV value=''}
                                                            {foreach item=VISITACCOUNT from=$VISITACCOUNTCONTRACT['data']}
                                                                <tr>
                                                                    {if $VISITACCOUNT['classict'] neq $TEMPV}
                                                                    <td rowspan="{$VISITACCOUNTCONTRACT['basic'][$VISITACCOUNT['classict']]}">{$VISITACCOUNT['classic']}</td>
                                                                        {assign var=TEMPV value=$VISITACCOUNT['classict']}
                                                                    {/if}
                                                                    <td> {$VISITACCOUNT['commentresult']}</td>
                                                                    <td>{$VISITACCOUNT['remark']}</td>
                                                                    <td>{$VISITACCOUNT['commentdatetime']}</td>
                                                                </tr>
                                                            {/foreach}
                                                            </tbody>
                                                        </table>
    ...
    <div class="span6 hiddensc" style="margin:5px;background-color:#ffffff">
        <div class="accordion-group">
            <div class="accordion-heading">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="span12" style="border:1px #ddd dashed;padding:2px;">
                                    <div class="row-fluid">
                                        <div class="{if !empty($VISITIMPROVEMENT['improveschedule'])}span4{else}span11{/if}">
