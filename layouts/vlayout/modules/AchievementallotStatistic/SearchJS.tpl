...
{strip}
    ...
    <script type="text/javascript">
        ...
        {if !$FIELD_MODEL->getrolePermission('readonly') || in_array($FIELD_MODEL->getDisplayType(),array(3,4,5))}
        {continue}
        {/if}
        ...
        var field_currency_operator = '<select id=\"BugFreeQuery_operator999999\" style=\"width:100%\" onchange=\"updateQueryValue(999999,true);\" name=\"BugFreeQuery[operator999999]\"><option value=\"&gt;=\" selected=\"selected\">大于等于</option><option value=\"&lt;=\">小于等于</option></select>';
    ...
    <script type="text/javascript">
        ...
        function updateQueryValue(index,isKeepOldValue)
        {
            ...
            if(fieldType == 'datetime'||fieldType == 'date'){
                //console.log(1111);
                if($fieldName=='achievementmonth'){
                    $('#'+searchParamsPreFix+'_value'+index).replaceWith('<input class="span9 dateField form_datetime" id="BugFreeQuery_value'+index+'" name="BugFreeQuery[value'+index+']" size="8" type="text" name="" value=""  >');
