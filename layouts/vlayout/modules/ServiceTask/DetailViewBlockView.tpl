...
{strip}
	...
	<table class="table table-bordered equalSplit detailview-table {if $BLOCK_LABEL_KEY eq $ASSIGN_TYPE}hide tableadv{/if}">
		<thead>
		<tr>
			 ...
			 {if in_array($FIELD_MODEL->get('name'),$RUNCONDITION_FIELD_NAMES)}
				{if $IS_SET eq '0'}
					...
					<td class="fieldValue {$WIDTHTYPE}" colspan="3">
						{include file="RunConditionItemsDetail.tpl"|@vtemplate_path:'ServiceTask'}
				    </td>
					</tr>
				{/if}
