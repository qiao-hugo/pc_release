{strip}
    <form action="index.php?module=ContractGuarantee&view=List&public=ExportRID" method="post">
    <table class="table table-bordered equalSplit detailview-table"><thead>
        <th colspan="2">担保合同导出</th></thead><tbody>
        ...
        <tr><td style="text-align: right">担保确认日期
            </td><td>
