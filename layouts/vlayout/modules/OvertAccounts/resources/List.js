...
Vtiger_List_Js("OvertAccounts_List_Js",{},{
						...
						if(data.success) {
                            ...
                            if(postData.type=='SELF'){
                                ...
                                Vtiger_Helper_Js.showConfirmationBox({'message' : message1}).then(
                                    function(e){},function(e){location.href='/index.php?module=OvertAccounts&view=Detail&record='+postData.record}
                                 );
							}else{
	...
	*/
	...
	registerLoadAjaxEvent:function(){
		$('body').on(Vtiger_List_Js.loadAjax,function(e,data){
			//console.log(11111);
			var instace=new OvertAccounts_List_Js;
...
setAdvancesmoney : function () {
    ...
    listViewContentDiv.on("click",".stampall",function(event){
            var message = app.vtranslate('LBL_TEMPORARY_CONFIRMATION');
