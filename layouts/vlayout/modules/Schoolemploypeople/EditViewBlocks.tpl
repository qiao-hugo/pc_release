		...
		{foreach key=BLOCK_LABEL item=BLOCK_FIELDS from=$RECORD_STRUCTURE name="EditViewBlockLevelLoop"}
			...
			<tr>
				<td class="fieldLabel medium">
					<label class="muted pull-right marginRight10px"><span class="redColor">*</span> 姓名</label>
				</td>
				...
				<td class="fieldLabel medium">
					<label class="muted pull-right marginRight10px"><span class="redColor">*</span> 性别</label>
				</td>
				<td class="fieldValue medium">
					<div class="row-fluid">
						<span class="span10">
			...
			<tr>
				<td class="fieldLabel medium">
					<label class="muted pull-right marginRight10px"><span class="redColor"></span> 电话</label>
				</td>
				<td class="fieldValue medium">
					<div class="row-fluid">
						<span class="span10">
				...
				<td class="fieldLabel medium">
					<label class="muted pull-right marginRight10px"><span class="redColor"></span> 邮箱</label>
				</td>
				<td class="fieldValue medium">
					<div class="row-fluid">
						<span class="span10">
