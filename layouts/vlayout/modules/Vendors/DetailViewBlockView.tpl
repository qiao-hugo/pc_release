...
{strip}
	...
	<input type=hidden name="isverify" data-value='{$ISVERIFY}' value="{$ISVERIFY}"/>
	<table class="table table-bordered equalSplit detailview-table">
        ...
        {if $BLOCK_LABEL_KEY eq 'LBL_VENDOR_ADDRESS_INFORMATION'}
			{assign var="VENDORBANK" value=$RECORD->getVendorBank($RECORD->getId())}
			{if !empty($VENDORBANK)}
				{foreach from=$VENDORBANK item=VENDORBANKVALUE}
					<table class="table table-bordered equalSplit detailview-table"><thead><tr><th class="blockHeader" colspan="4"><img class="cursorPointer alignMiddle blockToggle  hide  " src="layouts/vlayout/skins/softed/images/arrowRight.png" data-mode="hide" data-id="44"><img class="cursorPointer alignMiddle blockToggle " src="layouts/vlayout/skins/softed/images/arrowDown.png" data-mode="show" data-id="44">&nbsp;&nbsp;银行账户信息</th></tr></thead><tbody><tr><td class="fieldLabel medium" id="Vendors_detailView_fieldLabel_bankaccount"><label class="muted pull-right marginRight10px">开户行</label></td><td class="fieldValue medium" id="Vendors_detailView_fieldValue_bankaccount"><span class="value" data-field-type="string">
						{$VENDORBANKVALUE['bankaccount']}
					</span></td><td class="fieldLabel medium" id="Vendors_detailView_fieldLabel_bankname"><label class="muted pull-right marginRight10px">开户名</label></td><td class="fieldValue medium" id="Vendors_detailView_fieldValue_bankname"><span class="value" data-field-type="string">
						{$VENDORBANKVALUE['bankname']}
					</span></td></tr><tr><td class="fieldLabel medium" id="Vendors_detailView_fieldLabel_banknumber"><label class="muted pull-right marginRight10px">账  号</label></td><td class="fieldValue medium" id="Vendors_detailView_fieldValue_banknumber"><span class="value" data-field-type="string">
						{$VENDORBANKVALUE['banknumber']}
					</span></td><td class="fieldLabel medium" id="Vendors_detailView_fieldLabel_bankcode"><label class="muted pull-right marginRight10px">银行代码</label></td><td class="fieldValue medium" id="Vendors_detailView_fieldValue_bankcode"><span class="value" data-field-type="string">
					{$VENDORBANKVALUE['bankcode']}
					</span></td></tr><tr><td class="fieldLabel medium" id="Vendors_detailView_fieldLabel_allowtransaction"><label class="muted pull-right marginRight10px">允许交易</label></td><td class="fieldValue medium" id="Vendors_detailView_fieldValue_allowtransaction"><span class="value" data-field-type="boolean">
						{if {$VENDORBANKVALUE['allowtransaction']} eq 1}
							是
						{else}
							否
						{/if}
