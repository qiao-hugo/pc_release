{strip}
    ...
    <form action="index.php?module=Vendors&view=List&public=R_search" method="post" onsubmit="return sub();">
    <table class="table table-bordered equalSplit detailview-table"><thead>
        <th colspan="2">供应商查询</th></thead><tbody>
        ...
        <div class="row-fluid" id="c" style="width:100%;">
            <div style="border:1px solid #ccc;margin:0 auto 20px;padding-right:20px;padding-top:10px;">
                ...
                <table id="tbl_Detail" class="table listViewEntriesTable" width="100%"><thead><tr>
                        ...
                        <th nowrap><b>产品</b></th>
                        <th nowrap><b>返点</b></th>
                        <th nowrap><b>生效日期</b></th>
                        <th nowrap><b>失效日期</b></th>
                        <th nowrap><b>返点说明</b></th>
                       </tr>
                        </thead><tbody>
                {foreach item=value from=$VEBDORDATA}
                    <tr>
                        ...
                        <td nowrap><b>{$value['rebate']}
                            </b></td>
                        <td nowrap><b>{$value['effectdate']}</b></td>
                        <td nowrap><b>{$value['enddate']}</b></td>
                        <td nowrap><b>{$value['vexplain']}</b></td>
                    </tr>
                {/foreach}
                </tbody></table>
                </div>
