...
Vtiger_Detail_Js("Schoolemploy_Detail_Js",{
},{
	convertGotoEmploy: function() {
		/*$('.gotoEmploy').click(function () {
				var msg = {
	                'message': '确定要生成实训名单',
	                "width":"500px",
	            };
	...
	init: function() {
		$('#Schoolemploy_detailView_basicAction_LBL_ADD_RECORD').remove();
	},
	registerEvents:function(){
		this._super();
		this.convertGotoEmploy();
		this.init();
	}
});