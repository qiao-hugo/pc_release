    ...
    <div class="listViewTopMenuDiv noprint">
        ...
        <div> <form method="post"  name="SearchBug" id="SearchBug">
                ...
                <div id="SearchBlankCover" style="background-color: #F0F0F0;">
                    ...
                    {include file='../DelayMatch/SearchJS.tpl'|@vtemplate_path MODULE=$MODULE}
            </form>
        </div>
        </div>
        {include file='../DelayMatch/DefaultListFields.tpl'|@vtemplate_path MODULE=$MODULE ISDEFAULT=true ISPAGE=true}
