{strip}
    ...
    <table class="table table-bordered equalSplit detailview-table"><thead>
        <form action="index.php?module=Newinvoice&view=List&public=pre_invoice_dela" method="post">
            <th colspan="2"><h4>预开票回款延期设置</h4></th></thead><tbody>
        <tr><td style="text-align: right"><span class="redColor">*</span>审核类型
                ...
                <select id="auditsettingtype" class="chzn-select referenceModulesList streched" name="auditsettingtype">
                    <option value="PreInvoiceDelay">预开票回款延期</option>
                </select>
            </td></tr>
        ...
        <tr><td style="text-align: right"><span class="redColor">*</span>审核人
            </td><td>
    ...
    <script>
        ...
        $(function(){
            $('#preview').click(function(){
                ...
                params['mode'] = 'addNewInvoiceDelay';
            ...
            $('.listViewEntriesTable').on('click','.deleteRecord',function(){
                ...
                Vtiger_Helper_Js.showConfirmationBox(msg).then(function(e) {
                    ...
                    params['action'] = 'BasicAjax';
                    params['module'] = module;
                    params['mode'] = 'updateNewInvoiceDelay';
