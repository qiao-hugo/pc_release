{strip}
    <form action="index.php?module=Newinvoice&view=List&filter=contract_change_invoice_data" method="post">
    <table class="table table-bordered equalSplit detailview-table"><thead>
        <th colspan="2">合同变更发票导出</th></thead><tbody>
        ...
        <tr><td style="text-align: right">变更合同日期
            </td><td>
