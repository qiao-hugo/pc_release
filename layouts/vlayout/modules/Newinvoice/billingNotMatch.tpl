{strip}
    <form action="index.php?module=Newinvoice&view=List&filter=search_billingNotMatchData" method="post">
    <table class="table table-bordered equalSplit detailview-table"><thead>
        <th colspan="2">预开票未匹配金额导出</th></thead><tbody>
        ...
        <tr><td style="text-align: right">负责人
            </td><td>
                <label class="pull-left">
