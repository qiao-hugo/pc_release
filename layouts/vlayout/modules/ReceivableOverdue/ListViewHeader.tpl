...
{strip}
    ...
    <div> <form method="post"  name="SearchBug" id="SearchBug">
            ...
            <div id="SearchBlankCover" style="background-color: #F0F0F0;">
               ...
               {include file='SearchJS.tpl'|@vtemplate_path:'ReceivableOverdue' MODULE=$MODULE}
        </form>
    </div>
    </div>
        {include file='DefaultListFields.tpl'|@vtemplate_path:'ReceivableOverdue' MODULE=$MODULE ISDEFAULT=true ISPAGE=true}
    {else}{/if}
