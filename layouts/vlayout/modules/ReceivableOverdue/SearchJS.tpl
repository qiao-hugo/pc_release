...
{strip}
    ...
    <script type="text/javascript">
        ...
        {elseif $FIELD_NAME eq 'checkresult'}
        var field_{$FIELD_NAME|trim}_value = '<select id=\"BugFreeQuery_value999999\" style=\"width:100%;\" class=\"chzn-select\" name=\"BugFreeQuery[value999999]\"><option value=\"\">选择一个选项</option><option value=\"-1\">未核对</option><option value=\"0\">不符合</option><option value=\"1\">符合</option></select>';
        ...
        var field_string_operator = '<select id=\"BugFreeQuery_operator999999\" style=\"width:100%\" onchange=\"updateQueryValue(999999,true);\" name=\"BugFreeQuery[operator999999]\"><option value=\"LIKE\"  selected=\"selected\">包含</option><option value=\"=\">等于</option></select>';
        ...
        var field_text_operator = '<select id=\"BugFreeQuery_operator999999\" style=\"width:100%\" onchange=\"updateQueryValue(999999,true);\" name=\"BugFreeQuery[operator999999]\"><option value=\"LIKE\"  selected=\"selected\">包含</option><option value=\"=\">等于</option></select>';
