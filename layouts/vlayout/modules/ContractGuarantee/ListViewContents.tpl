            ...
            <td class="listViewEntryValue" >
                {if $LISTVIEW_HEADER@last}
                    ...
                    <div  style="width:100px">
                        ...
                        {/if}
                        {if $LISTVIEW_ENTRY['workflowsnode'] eq '已完成'}
                                <a class="toVoidButton" style="margin-left: 6px;" dd="{$LISTVIEW_ENTRY['contractguaranteeid']}"><i title="查看担保合同使用情况"  class="icon-folder-close alignMiddle"></i></a>
                        {/if}
                        <a class="cancelContractButton" style="margin-left: 6px;" dd="{$LISTVIEW_ENTRY['contractguaranteeid']}"><i title="取消合同担保"  class="icon-remove-sign alignMiddle"></i></a>
                ...
                <thead>
                    <tr>
                        <th class="blockHeader" colspan="5">
                            ...
                            &nbsp;&nbsp; 担保使用详情&nbsp;&nbsp;<b class="pull-right"></b></th>
                    </tr>
                </thead>
                <tbody id='show_data1'>
