...
{*<select id="customFilter" style="display:none;">
            ...
            <div>
                ...
                <form method="post"  name="SearchBug" id="SearchBug">
                    ...
                    <div id="SearchBlankCover" style="background-color: #F0F0F0;">
                            ...
                            <table id="searchtable" style="margin:auto">
                                ...
                                <tr class="SearchConditionRow" id="SearchConditionRow0" style="height:22px;">
                                    ...
                                    <td>
                                        ...
                                        {assign var =Department value=getDepartmentNameAndParentName()}
                                        <select id="DepartFilter" name="department"  class="chzn-select">
                                            {foreach item="departname" key="departmentid" from=$Department}
                                                <option value="{$departmentid}" title="{$departname['parentdepartmentname']}">{$departname['departmentname']}</option>
                        ...
                        {include file='SearchJS.tpl'|@vtemplate_path:$MODULE MODULE=$MODULE}
                </form>
            </div>
