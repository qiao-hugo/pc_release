            ...
            <ul class="unstyled">
                <div class="bs-callout bs-callout-warning">
                    <li>
                        ...
                        <div>
                            <span><i>办公电话</i> :&nbsp;<strong>{$RECENT_ACTIVITIESAND['h']['phone_mobile']}</strong></span>
                            <span class="pull-right"><p class="muted"><small title=""></small></p></span>
                        </div>
                        <div>
                            <span><i>手机</i> :&nbsp;<strong>{$RECENT_ACTIVITIESAND['h']['phone_work']}</strong></span>
                            <span class="pull-right"><p class="muted"><small title=""></small></p></span>
                        </div>
                    </li>
                </div>
            ...
            <ul class="unstyled">
                <div class="bs-callout bs-callout-warning">
                    <li>
                        ...
                        <div>
                            <span><i>办公电话</i> :&nbsp;<strong>{$RECENT_ACTIVITIESAND['f']['phone_mobile']}</strong></span>
                            <span class="pull-right"><p class="muted"><small title=""></small></p></span>
                        </div>
                        <div>
                            <span><i>手机</i> :&nbsp;<strong>{$RECENT_ACTIVITIESAND['f']['phone_work']}</strong></span>
                            <span class="pull-right"><p class="muted"><small title=""></small></p></span>
                        </div>
                    </li>
                </div>
