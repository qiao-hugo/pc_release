                    ...
                    {else}
                        <div class="pull-right actions">
                            <span class="actionImages">
                                {if $RELATED_MODULE->get('name') eq  'Potentials'}
                                    <a target="_blank" href="index.php?module=Potentials&view=Detail&record={$COLUMN_DATA['potentialid']}&mode=showDetailViewByMode&requestMode=full"><i title="{vtranslate('LBL_SHOW_COMPLETE_DETAILS', $MODULE)}" class="icon-th-list alignMiddle"></i></a>&nbsp;
                                    <a href="index.php?module=Potentials&view=Edit&record={$COLUMN_DATA['potentialid']}"  target="_block"><i title="编辑" class="icon-pencil alignMiddle"></i></a>
                                    {else}
