...
<div class="filterContainer">
	...
	<div class="allConditionContainer conditionGroup contentsBackground well" style="margin-bottom:5px;">
		
		<div class="contents">
			<div class="conditionList">
				 {foreach item=CONDITION_INFO from=$ALL_CONDITION_CRITERIA['columns']}
					{include file='AdvanceFilterCondition.tpl'|@vtemplate_path:$QUALIFIED_MODULE RECORD_STRUCTURE=$RECORD_STRUCTURE CONDITION_INFO=$CONDITION_INFO MODULE=$MODULE NOCHOSEN=true}
				{/foreach}
			...
			<div class="addCondition" style="clear:both">
				<button type="button" class="btn btn-link"><strong>添加条件</strong></button>
			</div>
	...
	<div class="anyConditionContainer conditionGroup contentsBackground well" style="margin-bottom:5px;display:none">
		<div class="contents">
			<div class="conditionList">
			...
			<div class="addCondition" style="clear:both">
				<button type="button" class="btn btn-link"><strong>添加OR条件</strong></button>
			</div>
		</div>
	</div>
</div>
