...
<link rel="stylesheet" media="screen" type="text/css" href="libraries/jquery/datepicker/css/bootstrap-datepicker.min.css" />
		...
		{* ends *}
		<script type="text/javascript" src="libraries/jquery/Fixed-Header-Table/tableHeadFixer.js"></script>
	...
	<script>
        function changeWidth() {
            var a = $(window).width();
            if(a < 1650){
                (document.getElementsByClassName("bodyContents"))[0].style.marginTop = '90px';
            }else{
                (document.getElementsByClassName("bodyContents"))[0].style.marginTop = '40px';
            }
        }
