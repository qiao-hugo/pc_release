    ...
    <div class="container-fluid">
        <div class="row-fluid">
            <div class="span12">
                ...
                <div id="calendarview" style="width:80%;margin:0 auto;"></div>
            </div>
        </div>
...
{literal}
    ...
    $('#calendarview').fullCalendar({
    	...
    	eventClick: function(calEvent, jsEvent, view) {
                    ...
                    $('#showids').append('<span class="label label-a_exception"><label style="display:inline-block;"><input type="radio" name="datetype" value="work"'+workdaytype+'>&nbsp;&nbsp;上班</label></span><label  style="width:40px;display:inline-block;"></label><span class="label label-b_actioning"><label style="display:inline-block;"><input type="radio" name="datetype" value="holiday"'+holidaytype+'>&nbsp;&nbsp;休息</label></span>');
                    $.fancybox({
				        'type':'inline',
				        'href':'#showbox',
				        'onClosed':function(){
        ...
        events:'/index.php?module=Workday&action=BasicAjax&mode=getMothWork&__vtrftk='+csrfMagicToken
