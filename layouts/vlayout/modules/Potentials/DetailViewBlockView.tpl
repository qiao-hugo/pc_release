...
{strip}
    ...
    {foreach  key=key item=FIELD from=$DETAIL_INFO_LIST }
		<table class="table table-bordered equalSplit detailview-table">
			...
			<tr>
				<th class="blockHeader" colspan="4">
					<img class="cursorPointer alignMiddle blockToggle  hide"  src="layouts/vlayout/skins/softed/images/arrowRight.png" data-mode="hide" data-id=1>
					<img class="cursorPointer alignMiddle blockToggle"  src="layouts/vlayout/skins/softed/images/arrowDown.png" data-mode="show" data-id=1>&nbsp;&nbsp;销售/项目机会详情
					<span class="label label-a_normal">{$key+1}/{$DETAIL_INFO_LIST|@count}</span>
				</th>
			</tr>
			</thead>
			<tbody >
			<tr>
				<td class="fieldLabel {$WIDTHTYPE}" >
					<label class="muted pull-right marginRight10px">销售机会名称</label>
				</td>
				<td class="fieldValue {$WIDTHTYPE}"  >
					<span class="value" data-field-type="string">{$FIELD['potentialnames']}</span>
				</td>
				<td class="fieldLabel {$WIDTHTYPE}" >
					<label class="muted pull-right marginRight10px">可能性</label>
				</td>
				<td class="fieldValue {$WIDTHTYPE}"  >
					<span class="value" data-field-type="string">{$FIELD['probabilitys']}</span>
				</td>
			</tr>
			<tr>
				<td class="fieldLabel {$WIDTHTYPE}" >
					<label class="muted pull-right marginRight10px">销售阶段</label>
				</td>
				<td class="fieldValue {$WIDTHTYPE}" >
					<span class="value" data-field-type="string">{$FIELD['salesstages']}</span>
				</td>
				<td class="fieldLabel {$WIDTHTYPE}" >
					<label class="muted pull-right marginRight10px">预算区间</label>
				</td>
				<td class="fieldValue {$WIDTHTYPE}"  >
					<span class="value" data-field-type="string">{$FIELD['budgetinterval']}</span>
				</td>
			</tr>
			<tr>
				<td class="fieldLabel {$WIDTHTYPE}" >
				...
				<td class="fieldValue {$WIDTHTYPE}"  >
					<span class="value" data-field-type="string">{$FIELD['budgetlockstart']}~{$FIELD['budgetlockend']}</span>
				</td>
				<td class="fieldLabel {$WIDTHTYPE}" >
					<label class="muted pull-right marginRight10px">是否按年付费</label>
				</td>
				<td class="fieldValue {$WIDTHTYPE}" >
					<span class="value" data-field-type="string">{if $FIELD['isannuallypay']==1}是{else}否{/if}</span>
				</td>
			</tr>
			<tr>
				<td class="fieldLabel {$WIDTHTYPE}" >
					<label class="muted pull-right marginRight10px">对接角色</label>
				</td>
				<td class="fieldValue {$WIDTHTYPE}" >
					<span class="value" data-field-type="string">{$FIELD['dockingrole']}</span>
				</td>
				<td class="fieldLabel {$WIDTHTYPE}" >
					<label class="muted pull-right marginRight10px">对接人</label>
				</td>
				<td class="fieldValue {$WIDTHTYPE}" >
					<span class="value" data-field-type="string">{$FIELD['docker']}</span>
				</td>
			</tr>
			<tr>
				<td class="fieldLabel {$WIDTHTYPE}" >
					<label class="muted pull-right marginRight10px">项目具体情况</label>
				</td>
				<td colspan="3" class="fieldValue {$WIDTHTYPE}"  >
					<span class="value" data-field-type="string">{$FIELD['projectdetails']}</span>
				</td>
			</tr>
			</tbody>
		</table>
