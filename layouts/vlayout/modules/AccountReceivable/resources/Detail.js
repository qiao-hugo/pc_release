...
jQuery.Class("ContractExecution_Detail_Js",{
	...
	bindStagesubmit:function(){
		$('.details').on('click','.stagesubmit',function(){
            ...
            str += '<div class="add-execution" style="height:150px;"><div class="add-execution-tip"><span style="color: white">*</span></div><div class="add-execution-node">执行凭证</div><div class="add-execution-info"><input name="voucher" type="file" accept="application/pdf,image/jpeg,image/png"></div></div>';
