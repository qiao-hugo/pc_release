    ...
    <div>
        ...
        <form method="post"  name="SearchBug" id="SearchBug">
            ...
            <div id="SearchBlankCover" style="background-color: #F0F0F0;">
                ...
                {include file='SearchJS.tpl'|@vtemplate_path:'AccountReceivable' MODULE=$MODULE}
        </form>
    </div>
    {include file='DefaultListFields.tpl'|@vtemplate_path:'AccountReceivable' MODULE=$MODULE ISDEFAULT=true ISPAGE=true}
{/if}
