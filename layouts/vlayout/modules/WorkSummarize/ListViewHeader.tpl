...
-->*}
{strip}
	<div class="listViewPageDiv">{if $smarty.get.filter neq "nowrite"}
...
{/if}
    ...
    <div>
        {if $smarty.get.filter neq "nowrite"}
    ...
    {include file='../WorkSummarize/DefaultListFields.tpl'|@vtemplate_path MODULE=$MODULE ISDEFAULT=false ISPAGE=true}
{/if}
