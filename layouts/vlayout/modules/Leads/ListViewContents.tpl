            ...
            <td class="listViewEntryValue" >
                {if $LISTVIEW_HEADER@last}
                    ...
                    <div  style="width:90px">
                        ...
                        {/if}
                        {if ($LISTVIEW_ENTRY['leadcategroy'] eq 0 ) and !in_array($LISTVIEW_ENTRY['assignerstatus'],array('c_transformation','c_complete','c_Related','c_Forced_Related')) }
                        <a class="ChangeRecordButton" id="OVERT"> <i title="{vtranslate('LBL_TOOVERT', $MODULE)}" class="icon-shopping-cart alignMiddle"></i></a>
                        {elseif $LISTVIEW_ENTRY['leadcategroy'] eq 2}
