...
value="{if $FIELD_MODEL->get('fieldvalue')>0}{$FIELD_MODEL->get('fieldvalue')}{/if}" data-fieldinfo='{$FIELD_INFO}' {if !empty($SPECIAL_VALIDATOR)}data-validator={Zend_Json::encode($SPECIAL_VALIDATOR)}{/if} /> <span class="help-block">{$FIELD_MODEL->getHelp()}</span>
{/strip}
