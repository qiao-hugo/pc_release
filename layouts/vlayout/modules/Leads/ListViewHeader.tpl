...
-->*}
{strip}
    {assign var="NO_ACTION_NAME" value=['accountSearch','accountDeal','leadaccountdeal','leadsetting','leadbatch','cluesharing','assignpersonal']}
	<div class="listViewPageDiv">{if !in_array($smarty.get.filter,$NO_ACTION_NAME)}
...
{/if}
    ...
    <div>
        {if !in_array($smarty.get.filter,$NO_ACTION_NAME)}
        <form method="post"  name="SearchBug" id="SearchBug">
            ...
            <div id="SearchBlankCover" style="background-color: #F0F0F0;">
                ...
                {include file='SearchJS.tpl'|@vtemplate_path:'Leads' MODULE=$MODULE}
        </form>
    </div>
    {include file='DefaultListFields.tpl'|@vtemplate_path:'Leads' MODULE=$MODULE ISDEFAULT=true ISPAGE=true}
{/if}
