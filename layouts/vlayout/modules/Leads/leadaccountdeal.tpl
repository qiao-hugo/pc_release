{strip}
    ...
    <table class="table table-bordered equalSplit detailview-table"><thead>
        ...
        <tr><th colspan="2">成交客户列表</th></tr></thead><tbody>
            <tr><td><label class="pull-right">签订日期</label></td>
       ...
       $(document).ready(function(){
            $('#preview').click(function(){
                ...
                AppConnector.request(params).then(function (data){
                        ...
                        if(data.success){
                            var tablestr='<table id="tbl_Detail" class="table listViewEntriesTable" width="100%;"><thead><tr style="cursor:pointer;"><th nowrap><b>客户名称</b></th><th nowrap><b>来自市场部</b></th><th nowrap><b>第一份合同</b></th><th nowrap><b>合同类型</b></th><th nowrap><b>合同编号</b></th><th nowrap><b>合同金额</b></th><th nowrap><b>签订人员</b></th><th nowrap><b>签订部门</b></th><th nowrap><b>签订日期</b></th><th nowrap><b>类别区分</b></th><th nowrap><b>收款金额</b></th><th nowrap><b>人力成本</b></th><th nowrap><b>外采成本</b></th><th nowrap><b>总成本</b></th><th nowrap><b>毛利</b></th><th nowrap><b>20%毛利</b></th><th nowrap><b>备注</b></th></tr></thead><tbody>';
                            $.each(data.result,function(key,value){

                                tablestr+='<tr><td>'+value.accountname+'</td><td>'+value.firstfrommarket+'</td><td>'+value.firstcontract+'</td><td>'+value.contract_type+'</td><td>'+value.contract_no+'</td><td>'+value.total+'</td><td>'+value.signid+'</td><td>'+value.signdempart+'</td><td>'+value.signdate+'</td><td>&nbsp;</td><td>'+value.allpayments+'</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>';
                            });
