	...
	<table style="margin-left: auto;margin-right: auto;width: 100%;" class="searchUIBasic" cellspacing="12">
		...
		<tr>
			<td class="leftFormBorder1 importContents" width="40%" valign="top">
				{include file='NewImport_Step1.tpl'|@vtemplate_path:'ReceivedPaymentsClassify'}
			</td>
		</tr>
		<tr>
			<td align="right" colspan="2">
			{include file='NewImport_Basic_Buttons.tpl'|@vtemplate_path:'ReceivedPaymentsClassify'}
			</td>
		</tr>
	</table>
	<table style="margin-left: auto;margin-right: auto;width: 100%;" class="searchUIBasic" cellspacing="12">
