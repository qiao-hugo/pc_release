...
{strip}
	...
	<table class="table table-bordered equalSplit detailview-table">
		...
		<div class="widgetContainer_receivehistory" data-url="module=Products&view=Detail&mode=getproductinfo&amp;record={$RECORD->getId()}" data-name="Products">
	...
	{/foreach}
	<div class="widgetContainer_customerfields" data-url="module=Products&view=Detail&mode=showproductinfo&amp;record={$RECORD->getId()}" data-name="Products">
		<div class="widget_contents"></div>
	</div>
{/strip}