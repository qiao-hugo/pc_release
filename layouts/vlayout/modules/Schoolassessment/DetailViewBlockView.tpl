...
{strip}
	...
	<table class="table table-bordered blockContainer showInlineTable  detailview-table" id = "fallintotable">
        ...
        <tr >
            ...
            <td>{$VO['assessmentdescribe']}</td>
            <td>
            	<a target="_blank"  href="http://www.crm.com/index.php?module=Schoolresume&view=Detail&record={$VO['schoolresumeid']}"><i title="详细信息" class="icon-th-list alignMiddle"></i></a>&nbsp;

				<a target="_blank"  href="index.php?module=Schoolassessmentpeople&view=Edit&record={$VO['assessmentpeopleid']}"  target="_block"><i title="{vtranslate('LBL_EDIT', $MODULE)}" class="icon-pencil alignMiddle"></i></a>&nbsp;
            </td>
        </tr>
        {/foreach}
        </tbody>
