{strip}
    ...
    <form action="index.php?module=ReceivedPayments&view=List&public=ExportRDALL" method="post">
        <th colspan="2">保护数量</th></thead><tbody>
        <tr><td style="text-align: right"><span class="redColor">*</span>用户
            ...
            <tr><td style="text-align: right"><span class="redColor">*</span>保护数量
            </td><td>
                <label class="pull-left">
                    <input type="number" id="protectnum" step="1" />
                </label>
            </td></tr>
