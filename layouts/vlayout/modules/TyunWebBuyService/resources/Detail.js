...
Vtiger_Detail_Js("TyunWebBuyService_Detail_Js",{
    ...
    getconfirmrecord: function (requestUrl) {
        $("#TyunWebBuyService_detailView_basicAction_manuallycreatecontracts").on("click", function () {
            var message = '<br><span style="font-size: 16px;">确认手动创建电子合同吗？';
            var msg = {
                'message': message,
                'width': '400px'
            };
            ...
            Vtiger_Helper_Js.showConfirmationBox(msg).then(function (e) {
                var params = {
                    ...
                    'action': 'BasicAjax',
                    'mode': 'confirmCreateServiceContract',
                ...
                AppConnector.request(params).then(
                    function (data) {
                        ...
                        if (data.result.success) {
                            Vtiger_Helper_Js.showMessage({type: 'success', text: '确认创建电子合同成功'});
