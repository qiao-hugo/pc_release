...
<div style="margin-right:20px;margin-top:10px;">
    <div class="row-fluid" id="c" style="width:100%;">
            ...
            <table class="table">
                <tr>
                   ...
                   <td class="span5"><label class="pull-right">日期</label></td>
                    <td  class="span7"><label class="pull-left">
                            <input class="span9 dateField"type="text" id="datatime" value="{date("Y-m",strtotime('-3 month'))}-01" readonly style="width:100px;">
                        </label>
                ...
                <tr>
                    <td colspan="2"><label style="text-align:center"><input type="button" value="提交查询" id="PostQuery" name="PostQuery" class="btn"></label></td>
                </tr>
            </table>
        </div>
        ...
        <div style="border:1px solid #ccc;margin:0 auto 20px;padding-right:20px;">
            <div id="bartablev" class="span12" style="height:500px;"></div>
            <div class="clearfix"></div></div>
        </div>
