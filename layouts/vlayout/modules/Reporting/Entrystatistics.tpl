        ...
        <div style="border-right:1px #ccc solid;">
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td><label class="pull-right">负责人</label><input type="hidden" name="module" value="Reporting"><input type="hidden" name="mode" value="getentrystatisticsexp"><input type="hidden" name="action" value="selectAjax"></td>
                    ...
                    <td><label class="pull-right">入职年份</label></td>
