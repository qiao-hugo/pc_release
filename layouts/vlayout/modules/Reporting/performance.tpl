            ...
            var position = function(element) {
                ...
                $(window).scroll(function() { //侦听滚动时
                    ...
                    if (scrolls > 225) { //如果滚动到页面超出了当前元素element的相对页面顶部的高度
                        ...
                        $("#flaltt3>th").each(function(i){
                            $("#flalte3>th").eq(i).css({width:$("#flaltt3>th").eq(i).width()});
                        });
        ...
        <div style="border-right:1px #ccc solid;">
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td><label class="pull-right">负责人</label><input type="hidden" name="module" value="Reporting"><input type="hidden" name="mode" value="getPerformanceexp"><input type="hidden" name="action" value="selectAjax"></td>
                    ...
                    <td><label class="pull-right">业绩汇总年份</label></td>
