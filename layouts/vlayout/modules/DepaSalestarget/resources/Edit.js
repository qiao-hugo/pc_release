Vtiger_Edit_Js("DepaSalestarget_Edit_Js",{ },{
    ...
    relatedchange: function () {
        var sparams = {
            'module': 'DepaSalestarget',
            'action': 'BasicAjax',
            'record': $('select[name="createid"]').val(),
        ...
        AppConnector.request(sparams).then(
            function (datas) {
                if (datas.success == true) {
                	var d = datas.result;
                	$('#DepaSalestarget_editView_fieldName_department').val(datas.result.departmentname);
                }
            }
        );
    },
	...
	init: function() {
		// 界面初始化
		// 月份
		var year = $('#DepaSalestarget_editView_fieldName_year').val();
		var month = $('#DepaSalestarget_editView_fieldName_month').val();
		var last_name = $('#DepaSalestarget_editView_fieldName_createid').val();
		if (!year) {
			$('#DepaSalestarget_editView_fieldName_year').val($('input[name=defa_year]').val());
		}
		if (!month) {
			$('#DepaSalestarget_editView_fieldName_month').val($('input[name=defa_month]').val());
		}

		$('#DepaSalestarget_editView_fieldName_createid').val($('input[name=last_name]').val());
		
		$('#DepaSalestarget_editView_fieldName_year').attr('readonly', 'readonly');
		$('#DepaSalestarget_editView_fieldName_month').attr('readonly', 'readonly');
		$('#DepaSalestarget_editView_fieldName_createid').attr('readonly', 'readonly');
		$('#DepaSalestarget_editView_fieldName_department').attr('readonly', 'readonly');
		$('#DepaSalestarget_editView_fieldName_entrydate').attr('readonly', 'readonly');

		$('#DepaSalestarget_editView_fieldName_visitrate').attr('readonly', 'readonly');
		$('#DepaSalestarget_editView_fieldName_invitationrate').attr('readonly', 'readonly');
		$('#DepaSalestarget_editView_fieldName_achievementrate').attr('readonly', 'readonly');
