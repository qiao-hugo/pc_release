{strip}
    <div class="row" style="padding: 10px 20px 0 20px;">
         <span class="span4">
			...
			{/if}
                    <span class="btn-group">
					    <button id="{$MODULE}_listView_basicAction_export" class="btn btn-success exportButton"><strong>导出</strong></button>
					</span>
					{if $ISDEFAULT}
    ...
    &nbsp;<input onclick="Vtiger_List_Js.showUserFieldEdit('index.php?module={$MODULE}&view=FieldAjax');" class="btn"
             ...
             <span>
                 &nbsp;<a href="/index.php?module=Knowledge&view=Detail&record=2060" target="_blank" style="color:red;">代付款证明模板</a></span>
        </span>
        {if $ISPAGE}
