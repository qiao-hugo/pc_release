            ...
            <div>
                ...
                <form method="post"  name="SearchBug" id="SearchBug">
                    ...
                    <div id="SearchBlankCover" style="background-color: #F0F0F0;">
                        ...
                        {include file='../Staypayment/SearchJSDelay.tpl'|@vtemplate_path MODULE=$MODULE}
                </form>
            </div>
            {include file='DefaultListFieldsDelay.tpl'|@vtemplate_path:$MODULE MODULE=$MODULE ISDEFAULT=true ISPAGE=true}
            {/if}
