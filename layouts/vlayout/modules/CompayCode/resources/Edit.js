		...
		editViewForm.submit(function(e){
			if(typeof editViewForm.data('submit') != "undefined") {
				...
				if(editViewForm.validationEngine('validate')) {
					console.log(1);
					//保存前验证提交内容
                    var companyFullName=$("#CompayCode_editView_fieldName_companyfullname").val();
                    ...
                    if(!record){
                        ...
                        if(isSuccess){
                            Vtiger_Helper_Js.showMessage({type: 'error', text: "该公司名称已经使用过不能重复添加!"});
                            return false;
                        }
					}
