...
{strip}
    ...
    <script type="text/javascript">
        ...
        {elseif ($FIELD_MODEL->getFieldDataType() eq 'userDepartment') && ($FIELD_MODEL->get('name') eq 'authordepartment')}
        ...
        if(isUserDepartment){
        var field_userDepartment_operator = '<select id=\"BugFreeQuery_operator999999\" style=\"width:100%\" onchange=\"updateQueryValue(999999,true);\" name=\"BugFreeQuery[operator999999]\"><option value=\"=\"   selected=\"selected\">等于</option></select>';
        }else{
        ...
        var field_double_operator='<select id=\"BugFreeQuery_operator999999\" style=\"width:100%\" onchange=\"updateQueryValue(999999,true);\" name=\"BugFreeQuery[operator999999]\"><option value=\"=\"   selected=\"selected\">等于</option><option value=\"&gt;=\">大于等于</option><option value=\"&lt;=\">小于等于</option></select>';
