...
class Vtiger_FieldBasic {
	...
	function initialize($valuemap, $moduleInstance=false, $blockInstance=false) {
		...
		$this->ismultiple = $valuemap['ismultiple'];
        $this->searchtype = $valuemap['searchtype'];
        $this->reltablename = $valuemap['reltablename'];
        $this->relfieldmodule = $valuemap['relfieldmodule'];
        $this->reltablefield = $valuemap['reltablefield'];
        $this->reltablecol = $valuemap['reltablecol'];
        $this->isshowfield = $valuemap['isshowfield'];
        $this->reldefaultfield = $valuemap['reldefaultfield'];
        $this->relentityidfield = $valuemap['relentityidfield'];
        $this->relleftjoin = $valuemap['relleftjoin'];
        $this->prompt = $valuemap['prompt'];
        $this->listtabid = $valuemap['listtabid'];
