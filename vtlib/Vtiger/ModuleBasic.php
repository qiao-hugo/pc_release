...
class Vtiger_ModuleBasic {
	...
	function initialize($valuemap) {
		...
		$this->withupdate=$valuemap['withupdate'];
	 ...
	 * 新增version、parent两字段至vtiger_tab表(如果已有，则不会执行新增)
	 * 奇怪的方式... 难道是用此种方式来升级vtiger自身的吗？
	 * @access private
	 */
	 ...
	 * grouptable name is basetable + 'grouprel'<br>	--grouptable是兼容以前老版本的，6.0版本中无此表
	 */
