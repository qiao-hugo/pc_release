...
class Schoolassessment extends CRMEntity {
    var $db, $log; // Used in class functions of CRMEntity

    var $table_name = 'vtiger_schoolassessment';
    var $table_index= 'assessmentid';
    ...
    var $tab_name = Array('vtiger_crmentity','vtiger_schoolassessment');
    var $tab_name_index = Array('vtiger_crmentity'=>'crmid','vtiger_schoolassessment'=>'assessmentid');
    ...
    var $popup_fields = Array('assessmentid');

    // Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
    var $sortby_fields = Array();

    // For Alphabetical search
    var $def_basicsearch_col = 'assessmentid';

    // Column value to use on detail view record text display
    var $def_detailview_recname = 'assessmentid';

    // Required Information for enabling Import feature
    var $required_fields = Array('assessmentid'=>1);

    // Callback function list during Importing
    var $special_functions = Array('assessmentid');
    ...
    var $default_order_by = 'assessmentid';
    var $default_sort_order='ASC';
    // Used when enabling/disabling the mandatory fields for the module.
    // Refers to vtiger_field.fieldname values.
    var $mandatory_fields = Array('assessmentid');
