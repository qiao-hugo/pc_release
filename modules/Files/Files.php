...
class Files extends CRMEntity {
	var $log;
	var $db;
	var $table_name = "vtiger_files";
	var $table_index= 'attachmentsid';
    ...
    var $tab_name = Array('vtiger_files');
    var $tab_name_index = Array('vtiger_files'=>'attachmentsid');
	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('name', 'attachmentsid');
	...
	var $default_order_by = 'attachmentsid';
	...
	function Files() {
		...
		$this->column_fields = getColumnFields('Files');
	}
