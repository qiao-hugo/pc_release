...
class BusinessSysAnalysis_List_View extends Vtiger_KList_View {
    ...
    function process(Vtiger_Request $request){
        ...
        //$viewer->assign('USERDEPARTMENT',BusinessAnalysis_Record_Model::getuserinfo($str));
        //$viewer->assign('USERYEARS',BusinessAnalysis_Record_Model::getyears());
