...
class Schoolinterqua extends CRMEntity {
    var $db, $log; // Used in class functions of CRMEntity

    var $table_name = 'vtiger_schoolinterqua';
    var $table_index= 'schoolinterquaid';
    ...
    var $tab_name = Array('vtiger_crmentity', 'vtiger_schoolinterqua');
    var $tab_name_index = Array('vtiger_crmentity'=>'crmid', 'vtiger_schoolinterqua'=>'schoolinterquaid');
    ...
    var $popup_fields = Array('schoolinterquaid');

    // Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
    var $sortby_fields = Array();

    // For Alphabetical search
    var $def_basicsearch_col = 'schoolinterquaid';

    // Column value to use on detail view record text display
    var $def_detailview_recname = 'schoolinterquaid';

    // Required Information for enabling Import feature
    var $required_fields = Array('schoolinterquaid'=>1);

    // Callback function list during Importing
    var $special_functions = Array('schoolinterquaid');
...
/*    var $relatedmodule_list=array('Schoolresume');
    ...
    var $default_order_by = 'schoolinterquaid';
    var $default_sort_order='ASC';
    // Used when enabling/disabling the mandatory fields for the module.
    // Refers to vtiger_field.fieldname values.
    var $mandatory_fields = Array('schoolinterquaid');
