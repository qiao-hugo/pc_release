...
class ProductProvider_Module_Model extends Vtiger_Module_Model {
    ...
    public function getSideBarLinks($linkParams) {
        ...
        if($this->exportGrouprt('AccountPlatform','Import')){
            $quickLink8 = array(
                ...
                'linklabel' => '回款导入',
                'linkurl' => 'index.php?module=ProductProvider&view=Import',
                'linkicon' => '',
            );
        ...
        if(empty($this->searchfields)){
            ...
            foreach($moduleBlockFields as $moduleFields){
                foreach($moduleFields as $moduleField){
                    ...
                    if($isshowfield==1 && $moduleField->get('name')!='idaccount' && $moduleField->get('name')!='accountzh') {
                        continue;
                    }
