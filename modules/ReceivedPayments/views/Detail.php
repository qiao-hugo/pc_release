...
class ReceivedPayments_Detail_View extends Vtiger_Detail_View {
	...
	function getdetailinfo(Vtiger_Request $request){
       // var_dump($request);
        ...
        if(!empty($serviceids->fields['0'])){
            ...
            $viewer->view('detailwidgetContainer.tpl','ReceivedPayments');
        } 
	}
	...
	function getReceivedPaymentsUseDetail(Vtiger_Request $request){
        ...
        $viewer->view('UseDetailwidgetContainer.tpl','ReceivedPayments');
        exit;
    }
