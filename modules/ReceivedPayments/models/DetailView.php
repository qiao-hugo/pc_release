...
class ReceivedPayments_DetailView_Model extends Vtiger_DetailView_Model {
	...
	public function getDetailViewLinks($linkParams) {
        ...
        //核对，核对编辑按钮
        if($moduleModel->exportGrouprt('ReceivedPayments','COLLATE')) {
            $detailViewLinks[] = array(
                'linktype' => 'DETAILVIEWBASIC',
            ...
            if($recordModel->get("ismatchdepart")){
                $collateId = $recordModel->getCollateIdByRecord($recordId);
                if($collateId){
                    $detailViewLinks[] = array(
                        'linktype' => 'DETAILVIEWBASIC',
                        'linklabel' => 'LBL_COLLATE_EDIT',
                        'linkurl' => 'index.php?module=ReceivedPaymentsCollate&view=Detail&record='.$collateId,
                        'linkicon' => ''
                    );
                }else{
                    $detailViewLinks[] = array(
                        'linktype' => 'DETAILVIEWBASIC',
                        'linklabel' => 'LBL_COLLATE_EDIT',
                        'linkurl' => 'index.php?module=ReceivedPaymentsCollate&view=Edit&sc_record='.$recordId,
                        'linkicon' => ''
                    );
                }
            }
...
// 		}
	...
	public function getDetailViewRelatedLinks() {
		...
		if($parentModuleModel->isTrackingEnabled()) {
            ...
            $relatedLinks[] = array(
                'linktype' => 'DETAILVIEWTAB',
                'linklabel' => 'LBL_ChangeDetails',
                'linkurl' => $recordModel->getDetailViewUrl().'&mode=showChangeDetails&page=1',
                'linkicon' => ''
            );
		}
			return $relatedLinks;
	 ...
	 * @return <Vtiger_DetailView_Model>
	 */
	public static function getInstance($moduleName,$recordId,$flag=false) {
		...
		$recordModel = Vtiger_Record_Model::getInstanceById($recordId, $moduleName,$flag);
