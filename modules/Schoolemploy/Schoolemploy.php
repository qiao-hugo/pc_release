...
class Schoolemploy extends CRMEntity {
    var $db, $log; // Used in class functions of CRMEntity

    var $table_name = 'vtiger_schoolemploy';
    var $table_index= 'schoolemployid';
    ...
    var $tab_name = Array('vtiger_crmentity','vtiger_schoolemploy');
    var $tab_name_index = Array('vtiger_crmentity'=>'crmid','vtiger_schoolemploy'=>'schoolemployid');
    ...
    var $popup_fields = Array('schoolemployid');

    // Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
    var $sortby_fields = Array();

    // For Alphabetical search
    var $def_basicsearch_col = 'schoolemployid';

    // Column value to use on detail view record text display
    var $def_detailview_recname = 'schoolemployid';

    // Required Information for enabling Import feature
    var $required_fields = Array('schoolemployid'=>1);

    // Callback function list during Importing
    var $special_functions = Array('schoolemployid');
    ...
    var $default_order_by = 'schoolemployid';
    var $default_sort_order='ASC';
    // Used when enabling/disabling the mandatory fields for the module.
    // Refers to vtiger_field.fieldname values.
    var $mandatory_fields = Array('schoolemployid');
