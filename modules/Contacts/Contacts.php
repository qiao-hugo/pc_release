...
class Contacts extends CRMEntity {
	...
	/*
	var $tab_name = Array('vtiger_crmentity','vtiger_contactdetails');
	var $tab_name_index = Array('vtiger_crmentity'=>'crmid','vtiger_contactdetails'=>'contactid');*/
	/**
  ...
  $log->debug("Exiting get_contactsforol method ...");
	...
	*/
    ...
    function retrieve_entity_info($record, $module){
		...
		//超过24小时不允许修改
		global $currentView;
		$where=getAccessibleUsers('Contacts','',true);
		if($where!='1=1'){
