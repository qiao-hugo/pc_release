<?php
Class ActivationCode_Edit_View extends Vtiger_Edit_View {
	public function process(Vtiger_Request $request) {
        ...
        $old_record = $recordModel->getOldProductInfo($record,$recordModel->get('classtype'));
        ...
        $arr_tyun = $recordModel->searchProductList($record);

        $viewer->assign('TYUN_PRODUCT_LIST', $arr_tyun['tyun_products']);
