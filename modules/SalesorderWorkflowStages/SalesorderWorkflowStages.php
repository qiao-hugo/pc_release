...
class SalesorderWorkflowStages extends CRMEntity {
    ...
    var $list_fields = Array (
        ...
        'Workflowstages Name'=> Array('salesorderworkflowstages', 'workflowstagesname'),
        'Salesorder Id'=> Array('salesorderworkflowstages', 'salesorderid'),
        'Schedule'=> Array('salesorderworkflowstages', 'schedule'),
        'Sequence'=>Array('salesorderworkflowstages','sequence')
    ...
    var $mandatory_fields = Array('workflowstagesname');
   ...
   function save_module($module) {
    ...
    function vtlib_handler($modulename, $event_type) {
        ...
        if($event_type == 'module.postinstall') {
			$projectTaskResult = $adb->pquery('SELECT tabid FROM vtiger_tab WHERE name=?', array('SalesorderWorkflowStages'));
	...
	static function isLinkPermitted($linkData) {
		$moduleName = "SalesorderWorkflowStages";
