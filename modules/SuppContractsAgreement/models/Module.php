...
class SuppContractsAgreement_Module_Model extends Vtiger_Module_Model{
	 ...
	 public function getSideBarLinks($linkParams) {
		...
		$quickLink = array(
         ...
         if($this->exportGrouprt('SuppContractsAgreement','dempartConfirm'))
         {
             $quickLink2 = array(
                 'linktype' => 'SIDEBARLINK',
                 'linklabel' => '采购/费用合同补充协议审核设置',
