...
class VisitAccountContract extends CRMEntity {
    var $db, $log; // Used in class functions of CRMEntity

    var $table_name = 'vtiger_visitaccountcontract';
    var $table_index= 'visitaccountcontractid';
    ...
    var $tab_name = Array('vtiger_visitaccountcontract');
    var $tab_name_index = Array('vtiger_visitaccountcontract'=>'visitaccountcontractid');
    ...
    var $popup_fields = Array('visitaccountcontractid');

    // Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
    var $sortby_fields = Array();

    // For Alphabetical search
    var $def_basicsearch_col = 'visitaccountcontractid';

    // Column value to use on detail view record text display
    var $def_detailview_recname = 'visitaccountcontractid';

    // Required Information for enabling Import feature
    var $required_fields = Array('visitaccountcontractid'=>1);

    // Callback function list during Importing
    var $special_functions = Array('visitaccountcontractid');
    ...
    var $default_order_by = 'visitaccountcontractid';
    var $default_sort_order='ASC';
    // Used when enabling/disabling the mandatory fields for the module.
    // Refers to vtiger_field.fieldname values.
    var $mandatory_fields = Array('visitaccountcontractid');
