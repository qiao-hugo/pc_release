...
class Schoolassessmentpeople_Detail_View extends Vtiger_Detail_View {
    ...
    function getSchoolresumeInfo(Vtiger_Request $request) {
        ...
        global $adb;
        $sql = "SELECT schoolresumeid FROM vtiger_schoolassessmentpeople WHERE assessmentpeopleid=?";
