...
class Schoolassessmentpeople_Save_Action extends Vtiger_Action_Controller {
	...
	public function saveRecord($request) {
		...
		if ($assessmentresult == 'assessmentresult_yes') {
			$sql = "update vtiger_schoolassessmentpeople set assessmentdate=? where assessmentpeopleid=?";
			global $adb;
			$adb->pquery($sql, array(date('Y-m-d H:i:s'), $record));
		}	
	...
	public function getDetailViewUrl($id) {
		return 'index.php?module=Schoolassessmentpeople&view=Detail&record='.$id;
	}
