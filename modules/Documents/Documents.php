...
class Documents extends CRMEntity {
	...
	var $tab_name = Array('vtiger_notes','vtiger_notescf');
	var $tab_name_index = Array('vtiger_notes'=>'notesid','vtiger_senotesrel'=>'notesid','vtiger_notescf'=>'notesid');
	...
	var $list_fields = Array(
				...
				'Assigned To' => Array('notes'=>'smownerid'),
	...
	*/
	function create_export_query($where)
	{
		...
		vtiger_groups.groupname end as user_name" .
				...
				LEFT JOIN vtiger_users ON vtiger_notes.smownerid=vtiger_users.id " .
				" LEFT JOIN vtiger_groups ON vtiger_notes.smownerid=vtiger_groups.groupid "
				;
		$query .= getNonAdminAccessControlQuery('Documents',$current_user);
		$where_auto=" vtiger_notes.deleted=0";
		if($where != "")
	...
	function generateReportsQuery($module,$queryplanner){
		...
		if ($queryplanner->requireTable("vtiger_users".$module)){
		    $query .= " left join vtiger_users as vtiger_users".$module." on vtiger_users".$module.".id = vtiger_notes.smownerid";
		}
		//$query .= " left join vtiger_groups on vtiger_groups.groupid = vtiger_crmentity.smownerid";
		$query .= " left join vtiger_users on vtiger_users.id = vtiger_notes.smownerid";
		if ($queryplanner->requireTable("vtiger_lastModifiedBy".$module)){
		    $query .= " left join vtiger_users as vtiger_lastModifiedBy".$module." on vtiger_lastModifiedBy".$module.".id = vtiger_notes.modifiedby ";
		}
		return $query;
