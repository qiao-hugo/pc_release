...
Class Invoice_Edit_View extends Vtiger_Edit_View {
    ...
    public function process(Vtiger_Request $request) {
        ...
        $viewer->assign('INVOICE_LIST',Invoice_Record_Model::editInoviceList($recordModel->entity->column_fields['contractid']));
        ...
        $viewer->assign('MOREINVOICES',Invoice_Record_Model::getMoreinvoice($record));
