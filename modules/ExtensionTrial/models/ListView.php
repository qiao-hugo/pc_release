...
class ExtensionTrial_ListView_Model extends Vtiger_ListView_Model {


	//根据参数显示数据
	public function getListViewEntries($pagingModel) {
		$db = PearDatabase::getInstance();
		$moduleName ='ExtensionTrial';
		...
		if(empty($orderBy) && empty($sortOrder)){
			...
			$orderBy = 'vtiger_extensiontrial.extensiontrialid';
			$sortOrder = 'DESC';
		}
		...
		while($rawData=$db->fetch_array($listResult)) {
            $rawData['id'] = $rawData['extensiontrialid'];

			$listViewRecordModels[$rawData['extensiontrialid']] = $rawData;
		}
