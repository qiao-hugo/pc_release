...
class PayApply_Detail_View extends Vtiger_Detail_View {
...
//        dd($recordModel);
        ...
        $sql = "select (select parentcate from vtiger_parentcate where vtiger_parentcate.parentcateid = vtiger_payapply.parentcate) as parentcate, (select soncate from vtiger_soncate where vtiger_soncate.soncateid = vtiger_payapply.soncate) as soncate FROM vtiger_payapply where payapplyid=?";
