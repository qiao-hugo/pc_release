...
class Schooladoptpeople extends CRMEntity {
    var $db, $log; // Used in class functions of CRMEntity

    var $table_name = 'vtiger_schooladoptpeople';
    var $table_index= 'schooladoptpeopleid';
    ...
    var $tab_name = Array('vtiger_schooladoptpeople');
    var $tab_name_index = Array('vtiger_schooladoptpeople'=>'schooladoptpeopleid');
    ...
    var $popup_fields = Array('schooladoptpeopleid');

    // Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
    var $sortby_fields = Array();

    // For Alphabetical search
    var $def_basicsearch_col = 'schooladoptpeopleid';

    // Column value to use on detail view record text display
    var $def_detailview_recname = 'schooladoptpeopleid';

    // Required Information for enabling Import feature
    var $required_fields = Array('schooladoptpeopleid'=>1);

    // Callback function list during Importing
    var $special_functions = Array('schooladoptpeopleid');
...
/*    var $relatedmodule_list=array('Schoolresume');
    ...
    var $default_order_by = 'schooladoptpeopleid';
    var $default_sort_order='ASC';
    // Used when enabling/disabling the mandatory fields for the module.
    // Refers to vtiger_field.fieldname values.
    var $mandatory_fields = Array('schooladoptpeopleid');
