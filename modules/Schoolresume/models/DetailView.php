...
class Schoolresume_DetailView_Model extends Vtiger_DetailView_Model {
    ...
    public function getDetailViewLinks($linkParams) {
        ...
        //print_r($entity);die;
        $shool_resume_source = $entity['shool_resume_source'];
        $linkModelList = Vtiger_DetailView_Model::getDetailViewLinks($linkParams);
        if( $shool_resume_source=='bidding_agency' && Users_Privileges_Model::isPermitted($moduleModel->getName(), 'EditView', $recordModel->getId())) {
        ...
        if(Users_Privileges_Model::isPermitted($moduleModel->getName(), 'EditView', $recordModel->getId())) {
            $basicActionLink = array(
                'linktype' => 'DETAILVIEWBASIC',
                'linklabel' => 'LBL_RELATED_LEAD_ADOPT',
                'linkurl' => '',
                'linkicon' => ''
            );
            $linkModelList['DETAILVIEWBASIC'][] = Vtiger_Link_Model::getInstanceFromValues($basicActionLink);
