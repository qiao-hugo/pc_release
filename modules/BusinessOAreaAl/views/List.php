...
class BusinessOAreaAl_List_View extends Vtiger_KList_View {
    ...
    function process(Vtiger_Request $request){
        ...
        //$viewer->assign('USERDEPARTMENT',BusinessOAreaAl_Record_Model::getuserinfo($str));
        //$viewer->assign('USERYEARS',BusinessOAreaAl_Record_Model::getyears());
