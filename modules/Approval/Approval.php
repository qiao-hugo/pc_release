...
class Approval extends CRMEntity {
	var $log;
	var $db;
	var $table_name = "vtiger_approval";
	var $table_index= 'approvalid';
    ...
    var $tab_name = Array('vtiger_approval');
    var $tab_name_index = Array('vtiger_approval'=>'approvalid');
	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('createid', 'approvalid');
	...
	var $default_order_by = 'approvalid';
	...
	function Approval() {
		...
		$this->column_fields = getColumnFields('Approval');
	}
