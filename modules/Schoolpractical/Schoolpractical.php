...
class Schoolpractical extends CRMEntity {
    var $db, $log; // Used in class functions of CRMEntity

    var $table_name = 'vtiger_schoolpractical';
    var $table_index= 'schoolpracticalid';
    ...
    var $tab_name = Array('vtiger_crmentity','vtiger_schoolpractical');
    var $tab_name_index = Array('vtiger_crmentity'=>'crmid','vtiger_schoolpractical'=>'schoolpracticalid');
    ...
    var $popup_fields = Array('schoolpracticalid');

    // Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
    var $sortby_fields = Array();

    // For Alphabetical search
    var $def_basicsearch_col = 'schoolpracticalid';

    // Column value to use on detail view record text display
    var $def_detailview_recname = 'schoolpracticalid';

    // Required Information for enabling Import feature
    var $required_fields = Array('schoolpracticalid'=>1);

    // Callback function list during Importing
    var $special_functions = Array('schoolpracticalid');
    ...
    var $default_order_by = 'schoolpracticalid';
    var $default_sort_order='ASC';
    // Used when enabling/disabling the mandatory fields for the module.
    // Refers to vtiger_field.fieldname values.
    var $mandatory_fields = Array('schoolpracticalid');
