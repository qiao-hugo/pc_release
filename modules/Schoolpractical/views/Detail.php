...
class Schoolpractical_Detail_View extends Vtiger_Detail_View {
    ...
    function showModuleDetailView(Vtiger_Request $request) {
        ...
        // 实训名单详情
        $schooladoptpeople = $this->getSchoolpracticalpeople($recordId);
    ...
    // 实训名单详情
    function getSchoolpracticalpeople($id) {
