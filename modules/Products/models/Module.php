	...
	public function getQueryByModuleField($sourceModule, $field, $record, $listQuery) {
		...
		if (($sourceModule == 'PriceBooks' && $field == 'priceBookRelatedList')
			...
			if ($sourceModule === $this->getName()) {
				$condition .= "vtiger_products.productid NOT IN (SELECT productid FROM vtiger_seproductsrel where setype='Products' UNION SELECT crmid FROM vtiger_seproductsrel WHERE productid = '$record')  AND vtiger_products.productid <> '$record' ";
