...
class Schooleligibility_Save_Action extends Vtiger_Action_Controller {
	...
	public function getDetailViewUrl($id) {
		return 'index.php?module=Schooleligibility&view=Detail&record='.$id;
	}
