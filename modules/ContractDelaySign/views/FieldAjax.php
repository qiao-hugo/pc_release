...
class ContractDelaySign_FieldAjax_View extends Vtiger_Index_View {
    ...
    function process (Vtiger_Request $request) {
        $mode = $request->get('report');
        $filtermode = $request->get('filtermode');
        ...
        foreach($listViewHeaders as $field){
            if(in_array($field['fieldlabel'],$continueColumn)){
                continue;
            }
