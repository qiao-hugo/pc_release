...
class EmployeeAbility extends CRMEntity {
	var $log;
	var $db;
	var $table_name = "vtiger_employee_ability";
	var $table_index= 'employeeabilityid';
    ...
    var $tab_name = Array('vtiger_employee_ability');
    var $tab_name_index = Array('vtiger_employee_ability'=>'employeeabilityid');
	/**
	...
	var $default_order_by = 'employeeabilityid';
