<?php
class EmployeeAbility_FileUpload_UIType extends Vtiger_FileUpload_UIType {
        ...
        if(!empty($newvalue[0])){
            ...
            foreach($newvalue as $val){
                ...
                if(count($val)>1){
                    ...
                    $str.='<a href=index.php?module='.$currentModule.'&action=DownloadFile&filename='.urlencode(base64_encode($fileid)).'>下载</a><br>';
                }else{
                    $str.=$val[0];
                }
            }
