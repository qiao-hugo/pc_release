...
class OrderChargeback_DetailView_Model extends Inventory_DetailView_Model {
    /**
     * 详细页面加上受控制的连接
    ...
    public function getDetailViewLinks($linkParams) {
        ...
        //if($recordModel->entity->column_fields['modulestatus']=='c_complete' && OrderChargeback_Record_Model::exportGroupri()) {
            $detailViewLinks[] = array(
                'linktype' => 'DETAILVIEWBASIC',
                'linklabel' => '打印预览',
                'linkurl' => 'window.open("index.php?module=OrderChargeback&action=ExportPDF&record='.$recordId.'")',
                'linkicon' => ''
            );
        //}
