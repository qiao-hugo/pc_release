<?php
class OrderChargeback_ChangeAjax_Action extends Vtiger_Action_Controller {
	...
	public function process(Vtiger_Request $request) {
        ...
        global $current_user;
        $sql="SELECT vtiger_workflowstages.handleaction as customer,iseditdata,isnextnode 	FROM 	vtiger_salesorderworkflowstages left JOIN vtiger_workflowstages ON (vtiger_salesorderworkflowstages.workflowstagesid=vtiger_workflowstages.workflowstagesid) WHERE vtiger_salesorderworkflowstages.salesorderworkflowstagesid =? LIMIT 1";
