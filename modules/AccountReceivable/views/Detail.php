...
class AccountReceivable_Detail_View extends Vtiger_Detail_View {
    ...
    function showModuleDetailView(Vtiger_Request $request) {
        ...
        $contractData = $recordModel->getContractsAndExecutionByAccountid();
        $viewer->assign('CONTRACTDATA', $contractData);
