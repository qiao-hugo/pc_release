...
class ContractActivaCode_Module_Model extends Vtiger_Module_Model{
    ...
    public function exportDataExcel($data){
        ...
        foreach($data['data'] as $value){
            $paymenttotal=$value['servicecontractstotal']-$value['paymenttotal'];
            ...
            $invoicetotal=$value['servicecontractstotal']-$value['invoicetotal'];
            ...
            $monthlyIncome=$value['servicecontractstotal']/$maxMonth;
            ...
            $accountsreceivable=$cumulativeIncome-$spaymenttotal;
            $phpexecl->setActiveSheetIndex(0)
