...
class ContractExecution_DetailView_Model extends Vtiger_DetailView_Model {
	...
	public function getDetailViewLinks($linkParams) {
        ...
        if($recordModel->get('frameworkcontract')=='yes' && $recordModel->get('bussinesstype')=='bigsass' &&
            Users_Privileges_Model::isPermitted($moduleName, 'EditView', $recordId))
            $detailViewLinks[] = array(
                'linklabel' => 'LBL_ADD_CONTRACTS_EXECUTION',
                'linkicon' => ''
            );
