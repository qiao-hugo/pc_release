...
class ContractExecution_Detail_View extends Vtiger_Detail_View {
    /**
...
//        }
        ...
        $execution_details = $recordModel->getExecutionDetails();
        $viewer->assign('CONTRACT_EXECUTION_DETAILS',$execution_details);
