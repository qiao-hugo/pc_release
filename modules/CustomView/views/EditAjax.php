...
Class CustomView_EditAjax_View extends Vtiger_IndexAjax_View {
	...
	public function process(Vtiger_Request $request) {
		...
		CRMEntity::getInstance($moduleName);
		global $all_crmtablename;
		$viewer->assign('ALLFIELDS_CURRENTMODEL', $all_crmtablename[$moduleName]);
	 ...
	 */
	public function getSearch(Vtiger_Request $request,$viewer){
		...
		//return $viewer->view('EditView.tpl', $module, true);
	}
}