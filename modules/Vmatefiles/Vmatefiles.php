...
class Vmatefiles extends CRMEntity {
	var $log;
	var $db;
	var $table_name = "vtiger_vmatefiles";
	var $table_index= 'vmateattachmentsid';
    ...
    var $tab_name = Array('vtiger_crmentity','vtiger_vmatefiles');
    var $tab_name_index = Array('vtiger_crmentity'=>'crmid','vtiger_vmatefiles'=>'vmateattachmentsid');
	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('name', 'vmateattachmentsid');
	...
	var $default_order_by = 'vmateattachmentsid';
	...
	function Vmatefiles() {
		...
		$this->column_fields = getColumnFields('Vmatefiles');
	}
