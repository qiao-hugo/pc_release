...
class RSalescomparison_List_View extends Vtiger_KList_View {
    ...
    function process(Vtiger_Request $request){
       ...
       /* $db = PearDatabase::getInstance();
        ...
        $viewer->assign('USERDEPARTMENT',RSalescomparison_Record_Model::getuserinfo($str));
        $viewer->assign('DEPARTMENTUSER',$cachedepartment);

        $viewer->assign('USERYEARS',RSalescomparison_Record_Model::getyears());
