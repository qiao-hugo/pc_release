...
class ContractReceivable extends CRMEntity {

    var $db, $log; // Used in class functions of CRMEntity
    var $table_name = 'vtiger_contract_receivable';
    var $table_index = 'contractreceivableid';
...
//    var $multirow_tables = array('vtiger_contracts_execution','vtiger_contracts_execution_detail','vtiger_servicecontracts');
     ...
     */
    var $tab_name = Array('vtiger_contract_receivable');

    /**
     * Mandatory for Saving, Include tablename and tablekey columnname here.
     */
    var $tab_name_index = Array(
        'vtiger_contract_receivable'   => 'contractreceivableid',
    );
    /**
    ...
    function retrieve_entity_info($record, $module) {
        ...
        if ($cachedModuleFields) {
            ...
            $sql = str_replace('FROM vtiger_contract_receivable','FROM vtiger_contract_receivable left join vtiger_servicecontracts on vtiger_servicecontracts.servicecontractsid=vtiger_contract_receivable.contractid',$sql);
            $sql = str_replace("vtiger_servicecontracts.bussinesstype","vtiger_contract_receivable.bussinesstype",$sql);
            $sql = str_replace("vtiger_contract_receivable.productid AS vtiger_contract_receivableproductid","vtiger_servicecontracts.contract_type AS vtiger_contract_receivableproductid",$sql);
