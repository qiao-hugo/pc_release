...
class Vtiger_UserDepartment_UIType extends Vtiger_Base_UIType {
	...
	public function getTemplateName() {
		return 'uitypes/UserDepartment.tpl';
	}
	...
	public function getEditViewDisplayValue($value) {
		if($value) {
			$userName = getDerparmentName($value);
			return $userName;
		}
	}
	...
	public function getDisplayValue($value, $recordId, $recordInstance=false) {
		...
		$currentUserModel = Users_Record_Model::getCurrentUserModel();var_dump($currentUserModel->isAdminUser());
