...
class Schooladopt extends CRMEntity {
    var $db, $log; // Used in class functions of CRMEntity

    var $table_name = 'vtiger_schooladopt';
    var $table_index= 'schooladoptid';
    ...
    var $tab_name = Array('vtiger_crmentity','vtiger_schooladopt');
    var $tab_name_index = Array('vtiger_crmentity'=>'crmid','vtiger_schooladopt'=>'schooladoptid');
    ...
    var $popup_fields = Array('schooladoptid');

    // Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
    var $sortby_fields = Array();

    // For Alphabetical search
    var $def_basicsearch_col = 'schooladoptid';

    // Column value to use on detail view record text display
    var $def_detailview_recname = 'schooladoptid';

    // Required Information for enabling Import feature
    var $required_fields = Array('schooladoptid'=>1);

    // Callback function list during Importing
    var $special_functions = Array('schooladoptid');
    ...
    var $default_order_by = 'schooladoptid';
    var $default_sort_order='ASC';
    // Used when enabling/disabling the mandatory fields for the module.
    // Refers to vtiger_field.fieldname values.
    var $mandatory_fields = Array('schooladoptid');
