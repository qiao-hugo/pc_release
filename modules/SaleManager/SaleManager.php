...
class SaleManager extends CRMEntity {
    var $db, $log; // Used in class functions of CRMEntity

    var $table_name = 'vtiger_salemanager';
    var $table_index= 'salerankid';
     ...
     */
    var $tab_name = Array('vtiger_salemanager');

    /**
     * Mandatory for Saving, Include tablename and tablekey columnname here.
     */
    var $tab_name_index = Array(
        'vtiger_salemanager'   => 'salerankid',);
