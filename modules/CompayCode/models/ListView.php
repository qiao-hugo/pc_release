...
class CompayCode_ListView_Model extends Vtiger_ListView_Model {


	//根据参数显示数据
	public function getListViewEntries($pagingModel) {
		$db = PearDatabase::getInstance();
		$moduleName ='CompayCode';
		...
		if(empty($orderBy) && empty($sortOrder)){
			...
			$orderBy = 'vtiger_company_code.companyid';
		...
		while($rawData=$db->fetch_array($listResult)) {
            $rawData['id'] = $rawData['companyid'];
			$listViewRecordModels[$rawData['companyid']] = $rawData;
		}
