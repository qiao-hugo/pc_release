...
class ReceivedPaymentsNotes_Detail_View extends Vtiger_Detail_View {
...
// 		$moduleName = $request->getModule();
// 		$viewer = $this->getViewer($request);
// 		$viewer->assign('EXAMINE_STATUS', $recordModel->get("examinestatus"));
// 		$viewer->assign('FOLLOW_STATUS', $recordModel->get("followstatus"));
