...
class ReceivedPaymentsNotes_Module_Model extends Vtiger_Module_Model {
    ...
    public function getSideBarLinks($linkParams) {
        ...
        if($this->exportGrouprt('ReceivedPaymentsNotes','Unboundlog')){
            $quickLink1 = array(
                'linktype' => 'SIDEBARLINK',
                'linklabel' => '回款解绑记录',
                'linkurl' => 'index.php?module=ReceivedPaymentsNotes&view=List&public=Unbound',
                'linkicon' => '',
            );
            $parentQuickLinks['SIDEBARLINK'][] = Vtiger_Link_Model::getInstanceFromValues($quickLink1);
        }
