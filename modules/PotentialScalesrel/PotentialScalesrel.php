...
class PotentialScalesrel extends CRMEntity {
    var $db, $log; // Used in class functions of CRMEntity

    var $table_name = 'vtiger_potentialscalesrel';
    var $table_index= 'potentialscalerelid';
     ...
     */
    var $tab_name = Array('vtiger_potentialscalesrel');

    /**
     * Mandatory for Saving, Include tablename and tablekey columnname here.
     */
    var $tab_name_index = Array(
        'vtiger_potentialscalesrel'   => 'potentialscalerelid',);
    ...
    var $list_fields = Array (
        ...
        'Scaleid'=> Array('potentialscalesrel', 'scaleid'),
    	'Scale'=>Array('potentialscalesrel','scale'),
        'Scaletime'=> Array('potentialscalesrel', 'scaletime'),
    	'Potentialscalename'=> Array('potentialscalesrel', 'potentialscalename'),
    ...
    var $list_fields_name = Array(
    	...
    	'Scale'=>'scale',
        'Scaletime'=> 'scaletime',
    	'Potentialscalename'=>  'potentialscalename',
    );

    // Make the field link to detail view from list view (Fieldname)
    var $list_link_field = 'potentialscaleid';
    ...
    var $popup_fields = Array('potentialscalename');

    // Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
    var $sortby_fields = Array();

    // For Alphabetical search
    var $def_basicsearch_col = 'potentialscalename';

    // Column value to use on detail view record text display
    var $def_detailview_recname = 'potentialscalename';

    // Required Information for enabling Import feature
    var $required_fields = Array('potentialscalename'=>1);

    // Callback function list during Importing
    var $special_functions = Array('set_import_assigned_user');

    var $default_order_by = 'potentialscalename';
    var $default_sort_order='ASC';
    // Used when enabling/disabling the mandatory fields for the module.
    // Refers to vtiger_field.fieldname values.
    var $mandatory_fields = Array('potentialsid');
   ...
   function save_module($module) {
    ...
    function vtlib_handler($modulename, $event_type) {
        ...
        if($event_type == 'module.postinstall') {
			$projectTaskResult = $adb->pquery('SELECT tabid FROM vtiger_tab WHERE name=?', array('PotentialScalesrel'));
