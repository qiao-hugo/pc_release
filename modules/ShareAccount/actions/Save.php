 ...
 * All Rights Reserved.
 *************************************************************************************/
class ShareAccount_Save_Action extends Vtiger_Save_Action {
    ...
    public function saveRecord($request) {
        ...
        if($accountid && $userid){
            ...
            if(empty($record)){
                ...
                $query='SELECT 1 FROM vtiger_shareaccount WHERE accountid=? AND userid=?';
                $result=$adb->pquery($query,array($accountid,$userid));
