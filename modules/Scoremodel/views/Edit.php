<?php
Class Scoremodel_Edit_View extends Vtiger_Edit_View {
	...
	public function process(Vtiger_Request $request) {
		...
		$scoreobjectData = Scoreobject_Record_Model::getScoreobject('Vendors');
		$viewer->assign('SCOREOBJECT', json_encode($scoreobjectData));

		$scoremodelContent = Scoremodel_Record_Model::getScoremodelContent($record);
        $viewer->assign('SCOREMODELCONTENT', $scoremodelContent);
