...
class RankProtect extends CRMEntity {
    var $db, $log; // Used in class functions of CRMEntity

    var $table_name = 'vtiger_rankprotect';
    var $table_index= 'rankid';
     ...
     */
    var $tab_name = Array('vtiger_rankprotect');

    /**
     * Mandatory for Saving, Include tablename and tablekey columnname here.
     */
    var $tab_name_index = Array(
        'vtiger_rankprotect'   => 'rankid',);
    ...
    var $list_fields_name = Array(
        ...
        'Manufacturer'=> 'accountrank',
		'Sales Rank'=> 'performancerank',
		'Commission Rate'=> 'protectday',
		'PRONUM'=>'protectnum',
    ...
    var $popup_fields = Array('rank');

    // Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
    var $sortby_fields = Array();

    // For Alphabetical search
    var $def_basicsearch_col = 'rank';

    // Column value to use on detail view record text display
    var $def_detailview_recname = 'rank';
    ...
    var $default_order_by = 'rank';
    var $default_sort_order='ASC';
    // Used when enabling/disabling the mandatory fields for the module.
    // Refers to vtiger_field.fieldname values.
    var $mandatory_fields = Array('rank');
