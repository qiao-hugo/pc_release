...
class OvertAccounts_DetailView_Model extends Vtiger_DetailView_Model {
	...
	public function getDetailViewRelatedLinks() {
        ...
        if($parentModuleModel->isCommentEnabled()) {
            $relatedLinks[] = array(
                ...
                'linkurl' => $recordModel->getDetailViewUrl('Accounts').'&mode=showRecentComments',
                'linkicon' => ''
            );
        }
        ...
        if($parentModuleModel->isTrackingEnabled()) {
            $relatedLinks[] = array(
                ...
                'linkurl' => $recordModel->getDetailViewUrl('Accounts').'&mode=showRecentActivities&page=1',
                'linkicon' => ''
            );
        }
	...
	public function getWidgets() {
		...
		if($moduleModel->isCommentEnabled() && $modCommentsModel->isPermitted('EditView')) {
			$widgets[] = array(
					...
					'linklabel' => 'ModComments',
					'linkurl' => 'module=Accounts&view=Detail&record='.$this->getRecord()->getId().
    ...
    public function getDetailViewLinks($linkParams) {
        ...
        $detailViewLinks[] = array(
            ...
            'linklabel' => 'LBL_FALL_TOOVERT_TIME',
            'linkurl' => '',
            'linkicon' => ''
        );
        }
