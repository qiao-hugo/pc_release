...
class OvertAccounts_List_View extends Vtiger_KList_View {
	...
	function process (Vtiger_Request $request) {
        ...
        if($report==1){
            ...
            $report1 = OvertAccounts_Record_Model::getReport();
            ...
            // 是否有垫款权限
            $viewer->assign('IS_ADVANCEMONY', Users_Privileges_Model::isPermitted('OvertAccounts', 'ConvertLead'));
