...
class BusinessOCRate_List_View extends Vtiger_KList_View {
    ...
    function process(Vtiger_Request $request){
        ...
        $viewer->assign('USERDEPARTMENT',BusinessOCRate_Record_Model::getuserinfo($str));
        $viewer->assign('USERYEARS',BusinessOCRate_Record_Model::getyears());
