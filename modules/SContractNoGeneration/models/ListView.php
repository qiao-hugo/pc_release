...
class SContractNoGeneration_ListView_Model extends Vtiger_ListView_Model {
	...
	public function getListViewEntries($pagingModel,$request=array()) {
		...
		$moduleName ='SContractNoGeneration';
		...
		if(empty($orderBy) && empty($sortOrder)){
			...
			$orderBy = 'scontractnogenerationid';
			$sortOrder = 'DESC';
		}
		$this->getSearchWhere();
		...
		while($rawData=$db->fetch_array($listResult)) {
            $rawData['id'] = $rawData['scontractnogenerationid'];
			$listViewRecordModels[$rawData['scontractnogenerationid']] = $rawData;
		}
