...
class Settings_Departments_Index_View extends Settings_Vtiger_Index_View {

	public function process(Vtiger_Request $request) {
		$viewer = $this->getViewer($request);
		$qualifiedModuleName = $request->getModule(false);
		$rootRole = Settings_Departments_Record_Model::getBaseDepartment();	// 顶级部门
		$allRoles = Settings_Departments_Record_Model::getAll();    	// 所有部门
