...
class Settings_Profiles_Module_Model extends Settings_Vtiger_Module_Model {
	...
	const IS_PERMITTED_VALUE = 1;
	const NOT_PERMITTED_VALUE = 0;
	...
	public static function getNonVisibleModulesList() {
        return array('ModTracker', 'Portal', 'Emails','RecycleBin','Rss','SMSNotifier','Webforms','CustomerPortal','EmailTemplates','Faq','HelpDesk','ProjectMilestone','Google','Webmails','Campaigns', 'Users', 'Mobile', 'Integration','Assets', 'WSAPP', 'ConfigEditor',
					'FieldFormulas', 'VtigerBackup', 'CronTasks','Documents','Services','Calendar','PriceBooks','PurchaseOrder', 'Import', 'Tooltip', 'CustomerPortal', 'Home'); 
    }
}
