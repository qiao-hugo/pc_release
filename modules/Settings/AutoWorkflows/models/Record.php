...
class Settings_AutoWorkflows_Record_Model extends Settings_Vtiger_Record_Model {
...
//保存是需要使用的两个方法 wangbin 
	...
	public static function getCleanInstance($moduleName) {
        ...
        $sql = 'select * from vtiger_autoworkflows_;';
		return self::getInstanceFromWorkflowObject($wf);
	}
//end
	...
	/*
	 * author wangibn 2015年7月15日 
	 * 查抄所有人员分组信息
	 */
	public function getgroup(){
	    $db = PearDatabase::getInstance();
	    $groupsql = "SELECT * FROM vtiger_groups";
	    $groupresult = $db->pquery($groupsql,array());
