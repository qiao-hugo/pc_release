...
class Schoolvisit extends CRMEntity {
    var $db, $log; // Used in class functions of CRMEntity

    var $table_name = 'vtiger_schoolvisit';
    var $table_index= 'schoolvisitid';
    ...
    var $tab_name = Array('vtiger_crmentity','vtiger_schoolvisit');
    var $tab_name_index = Array('vtiger_crmentity'=>'crmid','vtiger_schoolvisit'=>'schoolvisitid');
    ...
    var $popup_fields = Array('schoolvisitid');

    // Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
    var $sortby_fields = Array();

    // For Alphabetical search
    var $def_basicsearch_col = 'schoolvisitid';

    // Column value to use on detail view record text display
    var $def_detailview_recname = 'schoolvisitid';

    // Required Information for enabling Import feature
    var $required_fields = Array('schoolvisitid'=>1);

    // Callback function list during Importing
    var $special_functions = Array('schoolvisitid');
    ...
    var $default_order_by = 'schoolvisitid';
    var $default_sort_order='ASC';
    // Used when enabling/disabling the mandatory fields for the module.
    // Refers to vtiger_field.fieldname values.
    var $mandatory_fields = Array('schoolvisitid');
