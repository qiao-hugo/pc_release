...
class BusinessOpportunities_List_View extends Vtiger_KList_View {
    ...
    function process(Vtiger_Request $request){
        ...
        $viewer->assign('USERDEPARTMENT',BusinessOpportunities_Record_Model::getuserinfo($str));
        $viewer->assign('USERYEARS',BusinessOpportunities_Record_Model::getyears());
