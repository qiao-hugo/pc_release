...
class Vendors extends CRMEntity {
	...
	var $list_fields = Array(
		...
		var $relatedmodule_fields=array(
			'SupplierContracts'=>array('contract_no'=>'合同编号', 'suppliercontractsstatus'=>'合同类型', 'modulestatus'=>'合同状态', 'receivedate'=>'合同领取时间', 'signdate'=>'签订时间'),'Files'=>array('name'=>'name','uploader'=>'uploader','uploadtime'=>'uploadtime','style'=>'style','filestate'=>'filestate','deliversuserid'=>'deliversuserid','delivertime'=>'delivertime','remarks'=>'remarks'),
	...
	*/
    ...
    function retrieve_entity_info($record, $module){
        ...
        {
            throw new AppException('共享供应商不允许修改供应商信息!');
            exit;
        }
