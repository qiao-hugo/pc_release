...
class BusinessAnalysis_selectAjax_Action extends Vtiger_Action_Controller {
        ...
        switch($classes){
            case 'allocated':
                $sqlnew = "SELECT
                    ...
                    WHERE
                        deleted=0 {$tempdate} {$where} AND vtiger_leaddetails.purproduct='".$leadsnum."' AND vtiger_leaddetails.assignerstatus='c_allocated'";
                break;
            case 'transformation':
                $sqlnew = "SELECT
                        leadid,mapcreattime ,vtiger_leaddetails.accountid,accountname,vtiger_leaddetails.company,assignerstatus,description,
                    ...
                    LEFT  JOIN vtiger_account ON   vtiger_leaddetails.accountid=vtiger_account.accountid
                    WHERE
                        deleted=0 {$tempdate} {$where} AND vtiger_leaddetails.purproduct='".$leadsnum."' AND vtiger_leaddetails.assignerstatus='c_transformation'";
                break;
            case 'cancelled':
                $sqlnew = "SELECT
                        leadid,mapcreattime ,vtiger_leaddetails.accountid,accountname,vtiger_leaddetails.company,assignerstatus,description,
                    ...
                    LEFT  JOIN vtiger_account ON   vtiger_leaddetails.accountid=vtiger_account.accountid
                    WHERE
                        deleted=0 {$tempdate} {$where} AND vtiger_leaddetails.purproduct='".$leadsnum."' AND vtiger_leaddetails.assignerstatus='c_cancelled'";
                break;
            case 'firstcontr':
                $sqlnew = "SELECT
                        leadid,mapcreattime ,vtiger_leaddetails.accountid,accountname,vtiger_leaddetails.company,assignerstatus,description,
                    ...
                    WHERE
                        deleted=0 AND vtiger_leaddetails.accountid IS NOT NULL AND vtiger_leaddetails.accountid!=0 AND vtiger_servicecontracts.firstcontract=1 {$tempdate} {$where} AND vtiger_leaddetails.purproduct='".$leadsnum."'";
                break;
            case 'allvalue':
                $sqlnew = "SELECT
                        leadid,mapcreattime ,vtiger_leaddetails.accountid,accountname,vtiger_leaddetails.company,assignerstatus,description,
                    ...
                    LEFT JOIN vtiger_servicecontracts ON (vtiger_servicecontracts.sc_related_to=vtiger_leaddetails.accountid AND vtiger_servicecontracts.sc_related_to IS NOT NULL AND vtiger_servicecontracts.sc_related_to!=0)
                    WHERE
                        deleted=0 AND (vtiger_leaddetails.assignerstatus='c_allocated' OR vtiger_leaddetails.assignerstatus='c_cancelled' OR vtiger_leaddetails.assignerstatus='c_transformation' OR vtiger_servicecontracts.firstcontract=1) {$tempdate} {$where} AND vtiger_leaddetails.purproduct='".$leadsnum."'";
                break;
            default:
                break;
        }
