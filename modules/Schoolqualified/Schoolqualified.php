...
class Schoolqualified extends CRMEntity {
    var $db, $log; // Used in class functions of CRMEntity

    var $table_name = 'vtiger_schoolqualified';
    var $table_index= 'schoolqualifiedid';
    ...
    var $tab_name = Array('vtiger_crmentity','vtiger_schoolqualified');
    var $tab_name_index = Array('vtiger_crmentity'=>'crmid','vtiger_schoolqualified'=>'schoolqualifiedid');
    ...
    var $popup_fields = Array('schoolqualifiedid');

    // Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
    var $sortby_fields = Array();

    // For Alphabetical search
    var $def_basicsearch_col = 'schoolqualifiedid';

    // Column value to use on detail view record text display
    var $def_detailview_recname = 'schoolqualifiedid';

    // Required Information for enabling Import feature
    var $required_fields = Array('schoolqualifiedid'=>1);

    // Callback function list during Importing
    var $special_functions = Array('schoolqualifiedid');
    ...
    var $default_order_by = 'schoolqualifiedid';
    var $default_sort_order='ASC';
    // Used when enabling/disabling the mandatory fields for the module.
    // Refers to vtiger_field.fieldname values.
    var $mandatory_fields = Array('schoolqualifiedid');
