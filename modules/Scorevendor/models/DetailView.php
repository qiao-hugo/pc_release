...
class Scorevendor_DetailView_Model extends Vtiger_DetailView_Model {
    ...
    public function getDetailViewLinks($linkParams) {
        ...
        if(Users_Privileges_Model::isPermitted($moduleModel->getName(), 'EditView', $recordModel->getId())) {
            $basicActionLink = array(
                ...
                'linklabel' => 'LBL_RELATED_SCOREVENDOR',
                'linkurl' => '',
                'linkicon' => ''
            );
            ...
            $basicActionLink = array(
                'linktype' => 'DETAILVIEWBASIC',
                'linklabel' => 'LBL_RELATED_SCOREVENDOR_SHOW',
                'linkurl' => $recordModel->getDetailViewUrl() . '&public=show_paper_log',
                'linkicon' => ''
            );
            $linkModelList['DETAILVIEWBASIC'][] = Vtiger_Link_Model::getInstanceFromValues($basicActionLink);
        }
    ...
    public function getDetailViewRelatedLinks() {
        ...
        /*$relatedLinks[] = array(
            'linktype' => 'DETAILVIEWTAB',
            'linklabel' => '跟进',
            'linkurl' => $recordModel->getDetailViewUrl().'&mode=showRecentComments&page=undefined',
            'linkicon' => ''
        );*/
/*
