...
class Scorevendor_ListView_Model extends Vtiger_ListView_Model {
	...
	public function getListViewEntries($pagingModel,$request=array()) {
		...
		while($rawData=$db->fetch_array($listResult)) {
            $rawData['id'] = $rawData['scorevendorid'];
			$listViewRecordModels[$rawData['scorevendorid']] = $rawData;
		}
