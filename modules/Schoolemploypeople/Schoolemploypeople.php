...
class Schoolemploypeople extends CRMEntity {
    var $db, $log; // Used in class functions of CRMEntity

    var $table_name = 'vtiger_schoolemploypeople';
    var $table_index= 'schoolemploypeopleid';
    ...
    var $tab_name = Array('vtiger_schoolemploypeople');
    var $tab_name_index = Array('vtiger_schoolemploypeople'=>'schoolemploypeopleid');
    ...
    var $popup_fields = Array('schoolemploypeopleid');

    // Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
    var $sortby_fields = Array();

    // For Alphabetical search
    var $def_basicsearch_col = 'schoolemploypeopleid';

    // Column value to use on detail view record text display
    var $def_detailview_recname = 'schoolemploypeopleid';

    // Required Information for enabling Import feature
    var $required_fields = Array('schoolemploypeopleid'=>1);

    // Callback function list during Importing
    var $special_functions = Array('schoolemploypeopleid');
...
/*    var $relatedmodule_list=array('Schoolresume');
    ...
    var $default_order_by = 'schoolemploypeopleid';
    var $default_sort_order='ASC';
    // Used when enabling/disabling the mandatory fields for the module.
    // Refers to vtiger_field.fieldname values.
    var $mandatory_fields = Array('schoolemploypeopleid');
