...
class AutoTask_FileUpload_Action extends Vtiger_Save_Action {
	...
	public function process(Vtiger_Request $request) {
		...
		if($files['name'] != '' && $files['size'] > 0){
			...
			$upload_status = move_uploaded_file($filetmp_name, $upload_file_path . $current_id . "_" . base64_encode($binFile));
            $file_path = $root_directory.$upload_file_path . $current_id . "_" . base64_encode($binFile);
            //echo $file_path;
			$save_file = 'true';
