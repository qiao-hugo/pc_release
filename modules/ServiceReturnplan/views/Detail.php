...
class ServiceReturnplan_Detail_View extends Vtiger_Detail_View {
    ...
    function showModuleDetailView(Vtiger_Request $request) {
        ...
        $viewer->assign('RETURNPLAN_DETAIL',ServiceReturnplan_Record_Model::getReturnplan_detail($recordId));
