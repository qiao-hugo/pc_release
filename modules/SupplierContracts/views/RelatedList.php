...
class SupplierContracts_RelatedList_View extends Vtiger_RelatedList_View {
	function process(Vtiger_Request $request) {
        ...
        if($moduleModel->exportGrouprt('SupplierContracts','Download')){   //权限验证
            $viewer->assign('CAN_DOWNLOAD', 1);
        }

        if( $moduleModel->exportGrouprt('SupplierContracts','CanDelete') && $parentRecordModel->get("modulestatus")!='b_check'){
