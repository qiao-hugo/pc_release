...
*定义管理语句
*/
class SupplierContracts_RelationListView_Model extends Vtiger_RelationListView_Model {
	static $relatedquerylist = array(
        'Invoicesign'=>"SELECT invoicesignid as crmid,path FROM vtiger_invoicesign WHERE vtiger_invoicesign.invoiceid=?",
