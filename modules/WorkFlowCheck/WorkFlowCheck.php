...
class WorkFlowCheck extends CRMEntity {
    var $db, $log; // Used in class functions of CRMEntity

    var $table_name = 'vtiger_salesorderworkflowstages';
    var $table_index= 'salesorderworkflowstagesid';
     ...
     */
    var $tab_name = Array('vtiger_salesorderworkflowstages');
    ...
    var $list_fields = Array (
        ...
        'Rel Name'=> Array('receivedpaymentsid', 'relmodule'),
        'Rel Operate'=> Array('receivedpaymentsid', 'reloperate'),
        'Rel Id'=> Array('receivedpaymentsid', 'relid'),
        'Related to'=>Array('receivedpaymentsid','servicecontractsid')
    ...
    var $search_fields = Array(
        /* Format: Field Label => Array(tablename, columnname) */
        // tablename should not have prefix 'vtiger_'
        'Rel Name'=> Array('workflowrelevancesid', 'relmodule'),
        'Rel Operate'=> Array('workflowrelevancesid', 'reloperate'),
        'Rel Id'=> Array('workflowrelevancesid', 'relid'),
        'Related to'=>Array('workflowrelevancesid','workflowstagesid')
    );
    ...
    function __construct() {
        ...
        $cvfields=array(
            //添加测试
            array('vtiger_salesorderworkflowstages','salesorder_nono','salesorder_nono','SalesorderWorkflowStages_Salesorder_nono','V'),
                array('vtiger_salesorderworkflowstages','salesorderid','salesorderid','SalesorderWorkflowStages_Salesorder_Id','V'),
        		array('vtiger_salesorderworkflowstages','workflowstagesname','workflowstagesname','SalesorderWorkflowStages_Workflowstages_Name','V'),
        		array('vtiger_salesorderworkflowstages','actiontime','actiontime','SalesorderWorkflowStages_Actiontime','V'),
        		array('vtiger_salesorderworkflowstages','auditortime','auditortime','SalesorderWorkflowStages_Auditor_Time','V'),
        		array('vtiger_salesorderworkflowstages','workflowsid','workflowsid','SalesorderWorkflowStages_Workflowsid','V'),
                array('vtiger_salesorderworkflowstages','auditorid','auditorid','SalesorderWorkflowStages_Auditor_Id','V'),
        );
        Vtiger_Cache::set('zdcrm_','WorkFlowCheck_fields', $cvfields);
...
//         echo 12455;die;
    ...
    function vtlib_handler($modulename, $event_type) {
        ...
        if($event_type == 'module.postinstall') {
			$projectTaskResult = $adb->pquery('SELECT tabid FROM vtiger_tab WHERE name=?', array('WorkflowRelevances'));
