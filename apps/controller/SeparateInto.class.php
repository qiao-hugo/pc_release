...
class SeparateInto extends baseapp {
    public function one() {
        $id = $_REQUEST['id'];
        if (!empty($id)) {
            $params = array(
            ...
            $result = $this->call('oneSeparateInto', $params);
            $arr = array();
            ...
            $this->smarty->assign('divideInto', $result[2]);//分成成员列表
            ...
            $this->smarty->display('SeparateInto/one.html');
        }
    }
