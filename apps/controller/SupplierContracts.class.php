...
class SupplierContracts extends baseapp{
    ...
    public function index(){
        ...
        $search = array(
            array(
                'field'		=>"vtiger_suppliercontracts.modulestatus##16##3104##picklist",
                'operator'	=>"=",
                "value"		=>"b_check",
                "andor"		=>"OR",
                "leftParenthesesName"=>"("
            ...
            array(
                'field'		=>"vtiger_suppliercontracts.sideagreement##56##3677##boolean",
                'operator'	=>"=",
                "value"		=>"0",
                "andor"		=>"AND",
                //"rightParenthesesName"=>")"
        ...
        if(!empty($_POST['searchvalue']))
        {
            ...
            if($_POST['radiot']=='contract_no')
            {
                $search[] =array(
                    "leftParenthesesName"=>"(",
                    'field'		=>"vtiger_suppliercontracts.contract_no##1##3102##string",
                    'operator'	=>"LIKE",
            ...
            {
                $search[] = array(
                    'field'		=>"vtiger_vendor.vendorname##10##3111##reference",
                    'operator'	=>"LIKE",
                    "value"		=>$searchfieldvalue,
                    "andor"		=>"AND",
                );
        ...
        $list = $this->call('getSupplierContracts', $params);
        /*echo "<pre>";
        print_r($list);
        exit;*/
        $arr=array();
        ...
        $type = $_REQUEST['type'];
        if ($type == 'ajax') {
            $this->smarty->display('SupplierContracts/ajax.html');
        } else {
            $this->smarty->display('SupplierContracts/index.html');
        }
    }
    ...
    public function one() {
        ...
        if (! empty($id)) {
            ...
            $result = $this->call('oneSupplierContracts', $params);
            ...
            $modulestatus=array(
                ...
                'c_recovered'=>'已收回',
                'c_stamp'=>'已盖章',);
            $contractsstatus=array('GY'=>'业务供应商合同',
                            'GX'=>'行政供应商合同');
            $this->smarty->assign('USERIMGS',$arr);
            $this->smarty->assign('SupplierContracts', $result[0]);
            $this->smarty->assign('CONTRACTSSTATUS', $contractsstatus);
            ...
            $this->smarty->display('SupplierContracts/one.html');
        }
    }
