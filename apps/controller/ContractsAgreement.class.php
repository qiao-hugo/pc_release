...
class ContractsAgreement extends baseapp{
	...
	public function index(){
        ...
        $search = array(
            ...
            array(
                'field'		=>"vtiger_contractsagreement.modulestatus##16##3590##picklist",
                'operator'	=>"=",
                "value"		=>"b_check",
                "andor"		=>"OR",
                "leftParenthesesName"=>"("
            ...
            array(
                'field'		=>"vtiger_contractsagreement.modulestatus##16##1921##picklist",
                'operator'	=>"=",
                "value"		=>"b_actioning",
                "andor"		=>"AND",
        ...
        $list = $this->call('getContractsAgreement', $params);
        /*echo "<pre>";
        print_r($list);
        exit;*/
        $arr=array();
        ...
        $type = $_REQUEST['type'];
        if ($type == 'ajax') {
        	$this->smarty->display('ContractsAgreement/ajax.html');
        } else {
        	$this->smarty->display('ContractsAgreement/index.html');
        }
	}
    ...
    public function one() {
        ...
        if (! empty($id)) {
            ...
            $result = $this->call('oneContractsAgreement', $params);
            ...
            $modulestatus=array(
                ...
                'c_stamp'=>'已盖章',);
            $this->smarty->assign('USERIMGS',$arr);
            $this->smarty->assign('ContractsAgreement', $result[0]);
            ...
            $this->smarty->display('ContractsAgreement/one.html');
        }
    }
