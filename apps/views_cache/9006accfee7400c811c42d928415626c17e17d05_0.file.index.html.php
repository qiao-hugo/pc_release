<?php
/* Smarty version 3.1.28-dev/79, created on 2018-01-10 18:10:05
  from "/data/httpd/vtigerCRM/apps/views/SupplierContracts/index.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.28-dev/79',
  'unifunc' => 'content_5a55e67de7a467_30416412',
  'file_dependency' => 
  array (
    '9006accfee7400c811c42d928415626c17e17d05' => 
    array (
      0 => '/data/httpd/vtigerCRM/apps/views/SupplierContracts/index.html',
      1 => 1515578963,
      2 => 'file',
    ),
  ),
...
function content_5a55e67de7a467_30416412 ($_smarty_tpl) {
?>
<!DOCTYPE HTML>
<html>
<head>
	...
	<form action="index.php?module=SupplierContracts&action=index" method="post" data-ajax="false">
        <fieldset data-role="controlgroup" data-type="horizontal" data-mini="true" >
            <div class="ui-controlgroup-controls" data-inset="false">
                ...
                <div class="ui-radio"><label for="radio-v-1c" class="ui-btn ui-corner-all ui-btn-inherit ui-btn-icon-left ui-radio-off ui-last-child">供应商名称</label><input type="radio" name="radiot" id="radio-v-1c" value="accountname" <?php if ($_smarty_tpl->tpl_vars['fieldname']->value == 'accountname') {?>checked="checked"<?php }?>></div>
            </div>
        </fieldset>
...
$_smarty_tpl->ext->_updateScope->updateScope($_smarty_tpl, 'IMGMD', 0);?>
                    <li>
                        <a data-transition="slide" class="gotoOne" data-ajax="false" data-id="<?php echo $_smarty_tpl->tpl_vars['value']->value['suppliercontractsid'];?>
" href="/index.php?module=SupplierContracts&action=one&id=<?php echo $_smarty_tpl->tpl_vars['value']->value['suppliercontractsid'];?>
">
