<?php
/* Smarty version 3.1.28-dev/79, created on 2017-12-27 14:01:18
  from "/data/httpd/vtigerCRM/apps/views/ServiceContracts/one.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.28-dev/79',
  'unifunc' => 'content_5a43372ec84f28_08953096',
  'file_dependency' => 
  array (
    'b63a762472e88641bfa36f068b87edcac855191b' => 
    array (
      0 => '/data/httpd/vtigerCRM/apps/views/ServiceContracts/one.html',
      1 => 1510282778,
      2 => 'file',
    ),
  ),
...
function content_5a43372ec84f28_08953096 ($_smarty_tpl) {
?>
<!DOCTYPE HTML>
<html>
<head>
        ...
        <div id="data_list"  data-role="collapsible-set">
                ...
                <div  class="selector" data-role="collapsible"  data-collapsed="false">
                    ...
                    <div class="sales_info_div">
                        <span class="sales_title_t">服务合同编号:</span>
                        <?php echo $_smarty_tpl->tpl_vars['serviceContracts']->value['contract_no'];?>

                    </div>
                 
                    <div class="sales_info_div">
                        <span class="sales_title_t">合同状态:</span>
                        <?php echo $_smarty_tpl->tpl_vars['modulestatus']->value[$_smarty_tpl->tpl_vars['serviceContracts']->value["t_modulestatus"]];?>

                    </div>
                    <div class="sales_info_div">
                        <span class="sales_title_t">客户:</span>
                        <?php echo $_smarty_tpl->tpl_vars['serviceContracts']->value['accountname'];?>

                    </div>
                    <div class="sales_info_div">
                        <span class="sales_title_t">合同类型:</span>
                        <?php echo $_smarty_tpl->tpl_vars['serviceContracts']->value['contract_type'];?>

                    </div>
                    <div class="sales_info_div">
                        <span class="sales_title_t">合同领取人:</span>
                        <?php echo $_smarty_tpl->tpl_vars['serviceContracts']->value['smownerid_last_name'];?>
                    ...
                    <div class="sales_info_div">
                        ...
                        <?php echo $_smarty_tpl->tpl_vars['serviceContracts']->value['receivedate'];?>

                    </div>
                    <div class="sales_info_div">
                        <span class="sales_title_t">签订人:</span>
                        <?php echo $_smarty_tpl->tpl_vars['serviceContracts']->value['signid_last_name'];?>

                    </div>
                    <div class="sales_info_div">
                        <span class="sales_title_t">签订时间:</span>
                        <?php echo $_smarty_tpl->tpl_vars['serviceContracts']->value['signdate'];?>

                    </div>


                    <div class="sales_info_div">
                        <span class="sales_title_t">提单人:</span>
                        <?php echo $_smarty_tpl->tpl_vars['serviceContracts']->value['receiveid_last_name'];?>

                    </div>
                    <div class="sales_info_div">
                        <span class="sales_title_t">归还日期:</span>
                        <?php echo $_smarty_tpl->tpl_vars['serviceContracts']->value['returndate'];?>

                    </div>
                    <div class="sales_info_div">
                        <span class="sales_title_t">多工单类型:</span>
                        <?php echo $_smarty_tpl->tpl_vars['serviceContracts']->value['multitype'];?>
...
?>
                        <a href="index.php?module=ServiceContracts&action=download&filename=<?php echo urlencode(base64_encode($_smarty_tpl->tpl_vars['expfilename']->value['attachmentsid']));?>
...
,
                                ...
                                $.ajax({
                                    url: "index.php?module=ServiceContracts&action=photograph",    //请求的url地址
    ...
    $(function(){
        ...
        $('#refillApplication_examine').click(function () {
            ...
            $.ajax({ 
                url: "index.php?module=ServiceContracts&action=examine",
                data: {
        ...
        $('.addremarks').on('click',function(){
            ...
            $.ajax({
                url: "index.php?module=ServiceContracts&action=submitremark",
                data: {
                    stagerecordid : stagerecordid,
                    record : record,
                    reject : remarks
 ...
 type="text/javascript">
    ...
    function t_submit() {
        ...
        if (repulseinfo) {
            ...
            $.ajax({ 
                url: "index.php?module=ServiceContracts&action=repulse",
                data: {
                    stagerecordid : stagerecordid,
                    record : record,
