<?php
/* Smarty version 3.1.28-dev/79, created on 2018-02-09 19:29:17
  from "/data/httpd/vtigerCRM/apps/views/SuppContractsAgreement/one.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.28-dev/79',
  'unifunc' => 'content_5a7d860d63a838_76958008',
  'file_dependency' => 
  array (
    '14abc8c85d89307e09097f3b308efcc3bea0c2ee' => 
    array (
      0 => '/data/httpd/vtigerCRM/apps/views/SuppContractsAgreement/one.html',
      1 => 1518175752,
      2 => 'file',
    ),
  ),
...
function content_5a7d860d63a838_76958008 ($_smarty_tpl) {
?>
<!DOCTYPE HTML>
<html>
<head>
        ...
        <div id="data_list"  data-role="collapsible-set">
                ...
                <div  class="selector" data-role="collapsible"  data-collapsed="false">
                    ...
                    <div class="sales_info_div">
                        ...
                        <?php echo $_smarty_tpl->tpl_vars['SuppContractsAgreement']->value['contract_no'];?>

                    </div>
                    <div class="sales_info_div">
                        <span class="sales_title_t">补充协议编号:</span>
                        <?php echo $_smarty_tpl->tpl_vars['SuppContractsAgreement']->value['vtiger_suppcontractsagreementnewservicecontractsno'];?>

                    </div>
                 
                    <div class="sales_info_div">
                        <span class="sales_title_t">合同状态:</span>
                        <?php echo $_smarty_tpl->tpl_vars['modulestatus']->value[$_smarty_tpl->tpl_vars['SuppContractsAgreement']->value["vtiger_suppcontractsagreementmodulestatus"]];?>

                    </div>
                    <div class="sales_info_div">
                        <span class="sales_title_t">供应商:</span>
                        <?php echo $_smarty_tpl->tpl_vars['SuppContractsAgreement']->value['accountname'];?>

                    </div>
                    <div class="sales_info_div">
                        <span class="sales_title_t">负责人:</span>
                        <?php echo $_smarty_tpl->tpl_vars['SuppContractsAgreement']->value['smownerid_ref'];?>

                    </div>
                    <div class="sales_info_div">
                        <span class="sales_title_t">代领人:</span>
                        <?php echo $_smarty_tpl->tpl_vars['SuppContractsAgreement']->value['receiptorid'];?>
...
?>
                        <a href="index.php?module=SuppContractsAgreement&action=download&filename=<?php echo urlencode(base64_encode($_smarty_tpl->tpl_vars['expfilename']->value['attachmentsid']));?>
...
,
    ...
    $(function(){
        ...
        $('#refillApplication_examine').click(function () {
            ...
            $.ajax({ 
                url: "index.php?module=ContractsAgreement&action=examine",
                data: {
        ...
        $('.addremarks').on('click',function(){
            ...
            $.ajax({
                url: "index.php?module=ContractsAgreement&action=submitremark",
                data: {
                    stagerecordid : stagerecordid,
                    record : record,
                    reject : remarks
 ...
 type="text/javascript">
    ...
    function t_submit() {
        ...
        if (repulseinfo) {
            ...
            $.ajax({ 
                url: "index.php?module=ContractsAgreement&action=repulse",
                data: {
                    stagerecordid : stagerecordid,
                    record : record,
