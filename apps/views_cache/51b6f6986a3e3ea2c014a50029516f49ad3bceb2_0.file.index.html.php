<?php
/* Smarty version 3.1.28-dev/79, created on 2018-01-12 14:38:36
  from "/data/httpd/vtigerCRM/apps/views/ContractsAgreement/index.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.28-dev/79',
  'unifunc' => 'content_5a5857ec60bec5_87351364',
  'file_dependency' => 
  array (
    '51b6f6986a3e3ea2c014a50029516f49ad3bceb2' => 
    array (
      0 => '/data/httpd/vtigerCRM/apps/views/ContractsAgreement/index.html',
      1 => 1515739088,
      2 => 'file',
    ),
  ),
...
function content_5a5857ec60bec5_87351364 ($_smarty_tpl) {
?>
<!DOCTYPE HTML>
<html>
<head>
    <title>服务合同补充协议</title>
...
$_smarty_tpl->ext->_updateScope->updateScope($_smarty_tpl, 'IMGMD', 0);?>
                    <li>
                        <a data-transition="slide" class="gotoOne" data-ajax="false" data-id="<?php echo $_smarty_tpl->tpl_vars['value']->value['contractsagreementid'];?>
" href="/index.php?module=ContractsAgreement&action=one&id=<?php echo $_smarty_tpl->tpl_vars['value']->value['contractsagreementid'];?>
">
...
echo $_smarty_tpl->tpl_vars['USERIMGS']->value[$_smarty_tpl->tpl_vars['IMGMD']->value];
                            ...
                            <h2><?php echo $_smarty_tpl->tpl_vars['value']->value['newservicecontractsno'];?>
&nbsp;</h2>
 ...
 type="text/javascript">
    ...
    $(function(){
        ...
        function jsonajax(){
            ...
            $.ajax({
                url:'index.php?module=ContractsAgreement&action=index&type=ajax',
                type:'POST',
                data: {
                    pagenum: $num++,
                    type: 'ajax',
