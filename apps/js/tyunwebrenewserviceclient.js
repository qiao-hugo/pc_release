...
$(function () {
                ...
                success: function (data) {
                    ...
                    if (data.code==200) {
                        ...
                        if(temppackageprice>0){
                            console.log(temppackageprice+"计算的金额");
    ...
    $('#container').on('click','#submitfrom',function(){
        ...
        var str='<div class="weui-form-preview">' +
            ...
            '</div>' +
            // '<div class="weui-form-preview__item">' +
            // '<label class="weui-form-preview__label">续费日期</label>' +
    ...
    window.selectproductload=function(){
        ...
        console.log(selectproducttitle+"客户名称");
