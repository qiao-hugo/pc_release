<?php /* Smarty version Smarty-3.1.7, created on 2022-02-15 11:49:40
         compiled from "D:\phpstudy_pro\WWW\pc_release\includes\runtime/../../layouts/vlayout\modules\Staypayment\LineItemsWorkflows.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13160620b22d44dd3d8-03565296%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd5966566eca64074acd4bc2b9567fa4dbffe46f2' => 
    array (
      0 => 'D:\\phpstudy_pro\\WWW\\pc_release\\includes\\runtime/../../layouts/vlayout\\modules\\Staypayment\\LineItemsWorkflows.tpl',
      1 => 1631600680,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13160620b22d44dd3d8-03565296',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_620b22d455ccb',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_620b22d455ccb')) {function content_620b22d455ccb($_smarty_tpl) {?>
...
"/><input name="nowWorkFlowFlag" id="nowWorkFlowFlag" type="hidden" disabled  value="<?php echo $_smarty_tpl->tpl_vars['workflowstagesflag']->value;?>
"/><?php }?>&nbsp;<?php if (!in_array($_smarty_tpl->tpl_vars['workflowstagesflag']->value,array('CFO','DEPUTY'))){?><span style="color: red">请合同管理员确认已收到代付款证明原件且​原件与代付款信息及上传的附件一致时，点击确认  &nbsp;&nbsp;&nbsp;</span><div class="btn-group"><button type="button" class="btn stagesubmit">确认</button></div><?php }else{ ?><div class="btn-group"><button type="button" class="btn stagesubmit">审核</button></div><?php }?><?php }?><!--&nbsp;<button class="btn stagereset" data-name="SalesOrder" type="button" data-url="index.php" id="rejectbutton">打回</button>&nbsp;<button class="btn stagereset" data-name="SalesOrder" type="button" data-url="index.php" id="remarkbutton">备注</button>&nbsp;<button class="btn stagereset" data-name="SalesOrder" type="button" data-url="index.php" id="SalesorderProjectTasksrel">工单项目任务</button>-->&nbsp;</div></th></thead><tbody><tr><td colspan="3"><div style="padding:5px;"><?php $_smarty_tpl->tpl_vars['SCHEDULE'] = new Smarty_variable('0', null, 0);?><?php $_smarty_tpl->tpl_vars['actiontime'] = new Smarty_variable('-', null, 0);?><ul class="nav nav-pills"><?php  $_smarty_tpl->tpl_vars['vals'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['vals']->_loop = false;
...
</td></tr><?php } ?></table><?php $_smarty_tpl->tpl_vars['USERDEPARTMENT'] = new Smarty_variable(getDepartmentUser('H55'), null, 0);?><table class="table table-bordered equalSplit detailview-table "><thead><?php if (($_smarty_tpl->tpl_vars['ISROLE']->value&&$_smarty_tpl->tpl_vars['STAGERECORDID']->value)||in_array($_smarty_tpl->tpl_vars['USER']->value,$_smarty_tpl->tpl_vars['USERDEPARTMENT']->value)){?><tr class="hide realremarkbutton" nowrap><td colspan="2"><textarea class="row-fluid remark" id="remarkvalue" required="required" placeholder="请输入备注信息" name="description" ></textarea></td><td colspan="2"><div class="fileUploadContainer" style="float: right" xmlns="http://www.w3.org/1999/html"><div class="upload"><div style="display:inline-block;width:70px;height:30px;overflow: hidden;vertical-align: middle;"  title="文件名请勿包含空格"><div style="margin-top:-2px;">文件名请勿</div><div style="margin-top:-5px;">包含空格</div></div><input type="button" id="uploadexplainButton" value="上传"  title="文件名请勿包含空格" /><div style="display:inline-block" id="fileallexplain"><input class="ke-input-text explainfiledelete" type="hidden" name="explainfile" id="explainfile" value="" readonly="readonly" /><input class="explainfiledelete" type="hidden" name="attachmentsid" value=""></div></div></div></td><td colspan="2"><div class="pull-right"><button type="button" id="realremarkbutton" class="btn btn-success"><strong>保存</strong></button><a class="cancelLink" type="reset" onclick="$('.realremarkbutton').hide();">取消</a></div></td></tr><?php }?><tr><th class="detailViewBlockHeader" nowrap><img class="cursorPointer alignMiddle blockToggle hide" src="layouts/vlayout/skins/softed/images/arrowRight.png" data-mode="hide" data-id="61" style="display: none;"><img class="cursorPointer alignMiddle blockToggle " src="layouts/vlayout/skins/softed/images/arrowDown.png" data-mode="show" data-id="61">操作人</th><!--<div class="btn-group"><button type="button" class="btn stagesubmit">审核</button></div><th class="detailViewBlockHeader" nowrap>备注节点</th>--><th class="detailViewBlockHeader" width="60%">备注原因</th><th class="detailViewBlockHeader" nowrap>补充说明文件</th><th class="detailViewBlockHeader" nowrap>创建日期</th><th class="detailViewBlockHeader"nowrap>修改时间</th><th class="detailViewBlockHeader" nowrap><?php if (($_smarty_tpl->tpl_vars['ISROLE']->value&&$_smarty_tpl->tpl_vars['STAGERECORDID']->value)||in_array($_smarty_tpl->tpl_vars['USER']->value,$_smarty_tpl->tpl_vars['USERDEPARTMENT']->value)){?><div class="pull-right"><button type="button" onclick="$('.realremarkbutton').show();$('#remarkvalue').focus();" class="btn btn-info">添加备注</button>&nbsp;</div><?php }?></th></tr></thead><?php  $_smarty_tpl->tpl_vars['value'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['value']->_loop = false;
 $_smarty_tpl->tpl_vars['index'] = new Smarty_Variable;
...
</td><td nowrap ><a href="index.php?module=Staypayment&action=DownloadFile&type=1&filename=<?php echo base64_encode($_smarty_tpl->tpl_vars['value']->value["attachmentsid"]);?>
"><?php echo $_smarty_tpl->tpl_vars['value']->value["name"];?>
</i></a></td><td nowrap ><?php echo $_smarty_tpl->tpl_vars['value']->value["rejecttime"];?>
</td><td nowrap><?php echo $_smarty_tpl->tpl_vars['value']->value["modifytime"];?>
</td><td id="editremark" nowrap width="10%"><?php if ($_smarty_tpl->tpl_vars['USER']->value==$_smarty_tpl->tpl_vars['value']->value["rejectid"]&&false){?><a style="color:#00743e;" data-toggle="modal" data-target="#myModal" class="cursorPointer"><i class="icon-edit"></i>编辑</a><?php }?></td></tr><?php } ?></table><div id="projectselectdiv" style="display:none;"><select id="projectselect"><option>--请选择项目模版--</option><?php  $_smarty_tpl->tpl_vars['projectname'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['projectname']->_loop = false;
