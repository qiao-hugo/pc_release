<?php /* Smarty version Smarty-3.1.7, created on 2022-02-15 16:39:08
         compiled from "D:\phpstudy_pro\WWW\pc_release\includes\runtime/../../layouts/vlayout\modules\ReceivedPayments\SearchJS.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16663620b66ac51a916-80410274%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd270ba56b07a1ae1774900b869a430db86362bfa' => 
    array (
      0 => 'D:\\phpstudy_pro\\WWW\\pc_release\\includes\\runtime/../../layouts/vlayout\\modules\\ReceivedPayments\\SearchJS.tpl',
      1 => 1633673146,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16663620b66ac51a916-80410274',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_620b66ac55a74',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_620b66ac55a74')) {function content_620b66ac55a74($_smarty_tpl) {?>
<input type="hidden" value="" name="BugFreeQuery[queryRowOrder]" id="BugFreeQuery_QueryRowOrder"><script type="text/javascript">var limitedFieldCount = 8;var templateFieldNumber = '999999';var searchParamsPreFix = 'BugFreeQuery';var infoType = 'bug';var dateFormatError = '请输入正确的日期格式。例如，2009-10-8 或 -7。';var field_department_type='string';<?php  $_smarty_tpl->tpl_vars['FIELD_MODEL'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['FIELD_MODEL']->_loop = false;
...
';<?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldDataType()=='picklist'){?><?php if (in_array($_smarty_tpl->tpl_vars['FIELD_NAME']->value,array('first_collate_status','last_collate_status'))){?>var field_<?php echo trim($_smarty_tpl->tpl_vars['FIELD_NAME']->value);?>
_value = '<select id=\"BugFreeQuery_value999999\" style=\"width:100%\" class=\"chzn-select\" name=\"BugFreeQuery[value999999]\"><option value=\"\">选择一个选项</option><option value="fit">符合</option><option value="unfit">不符合</option></select>';<?php }else{ ?>var field_<?php echo trim($_smarty_tpl->tpl_vars['FIELD_NAME']->value);?>
...
</option><?php } ?></select>';<?php }?><?php }elseif($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldDataType()=='owner'){?><?php $_smarty_tpl->tpl_vars['USERSLIST'] = new Smarty_variable($_smarty_tpl->tpl_vars['FIELD_INFO']->value['picklistvalues']['用户'], null, 0);?>var field_<?php echo trim($_smarty_tpl->tpl_vars['FIELD_NAME']->value);?>
_value = '<select id=\"BugFreeQuery_value999999\" style=\"width:100%;\" class=\"chzn-select\" name=\"BugFreeQuery[value999999]\"><option value=\"\">选择一个选项</option><?php  $_smarty_tpl->tpl_vars['pick_list'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['pick_list']->_loop = false;
 $_smarty_tpl->tpl_vars['PICKLIST'] = new Smarty_Variable;
