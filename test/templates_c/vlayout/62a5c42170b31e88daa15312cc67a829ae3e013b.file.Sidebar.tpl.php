<?php /* Smarty version Smarty-3.1.7, created on 2022-02-16 10:11:13
         compiled from "D:\phpstudy_pro\WWW\pc_release\includes\runtime/../../layouts/vlayout\modules\Settings\Vtiger\Sidebar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:31585620c5d41b12fc0-79666094%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '62a5c42170b31e88daa15312cc67a829ae3e013b' => 
    array (
      0 => 'D:\\phpstudy_pro\\WWW\\pc_release\\includes\\runtime/../../layouts/vlayout\\modules\\Settings\\Vtiger\\Sidebar.tpl',
      1 => 1523874486,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '31585620c5d41b12fc0-79666094',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_620c5d41b517e',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_620c5d41b517e')) {function content_620c5d41b517e($_smarty_tpl) {?>
...
?><?php $_smarty_tpl->tpl_vars['menulist'] = new Smarty_variable($_smarty_tpl->tpl_vars['MENU']->value->getMenuItems(), null, 0);?><?php if (!empty($_smarty_tpl->tpl_vars['menulist']->value)){?><div class="quickWidget"><div class="accordion-heading accordion-toggle quickWidgetHeader" data-parent="#settingsQuickWidgetContainer" data-target="#Settings_sideBar_<?php echo Vtiger_Util_Helper::replaceSpaceWithUnderScores($_smarty_tpl->tpl_vars['MENU']->value->getLabel());?>
...
" data-action="pin" <?php }?> /><div class="clearfix"></div></div></div><?php } ?></div></div><?php }?><?php } ?></div>
<?php }} ?>