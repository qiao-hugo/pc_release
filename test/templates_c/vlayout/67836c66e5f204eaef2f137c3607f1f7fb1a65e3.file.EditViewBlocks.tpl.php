<?php /* Smarty version Smarty-3.1.7, created on 2022-02-15 10:08:49
         compiled from "D:\phpstudy_pro\WWW\pc_release\includes\runtime/../../layouts/vlayout\modules\Accounts\EditViewBlocks.tpl" */ ?>
<?php /*%%SmartyHeaderCode:27396620b00b946f0d9-06426497%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '67836c66e5f204eaef2f137c3607f1f7fb1a65e3' => 
    array (
      0 => 'D:\\phpstudy_pro\\WWW\\pc_release\\includes\\runtime/../../layouts/vlayout\\modules\\Accounts\\EditViewBlocks.tpl',
      1 => 1644890925,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '27396620b00b946f0d9-06426497',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_620b00b959a4d',
  'variables' => 
  array (
    'USER_MODEL' => 0,
    'MODULE' => 0,
...
" /><input type="hidden" name="educationproperty" value="" /><?php if ($_smarty_tpl->tpl_vars['IS_RELATION_OPERATION']->value){?><input type="hidden" name="sourceModule" value="<?php echo $_smarty_tpl->tpl_vars['SOURCE_MODULE']->value;?>
...
?><?php if (count($_smarty_tpl->tpl_vars['BLOCK_FIELDS']->value)<=0){?><?php continue 1?><?php }?><table class="table table-bordered blockContainer showInlineTable aaa"><tr><th class="blockHeader" colspan="4"><?php echo vtranslate($_smarty_tpl->tpl_vars['BLOCK_LABEL']->value,$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
"><?php }else{ ?><div class="row-fluid" <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name')=='industry'){?> style="width: 420px;" <?php }?>><span class="span10"><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getUITypeModel()->getTemplateName(),$_smarty_tpl->tpl_vars['MODULE']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('BLOCK_FIELDS'=>$_smarty_tpl->tpl_vars['BLOCK_FIELDS']->value), 0);?>
<?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name')=='newleadsource'){?><br><span style="color: orange">温馨提示：切勿瞎填，数据的准确性可帮助数据统计与分析</span><?php }elseif($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name')=='accountlabeling'){?><br><span style="color: red">提示：仅渠道部人员填写</span><?php }?></span></div><?php }?></td><?php }?><?php if (count($_smarty_tpl->tpl_vars['BLOCK_FIELDS']->value)==1&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="19"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="20"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="30"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name')!="recurringtype"){?><td class="<?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"></td><td class="<?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
