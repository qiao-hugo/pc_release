...
</td></tr><?php } ?></table><?php $_smarty_tpl->tpl_vars['USERDEPARTMENT'] = new Smarty_variable(getDepartmentUser('H55'), null, 0);?><table class="table table-bordered equalSplit detailview-table "><thead><?php if (($_smarty_tpl->tpl_vars['ISROLE']->value&&$_smarty_tpl->tpl_vars['STAGERECORDID']->value)||in_array($_smarty_tpl->tpl_vars['USER']->value,$_smarty_tpl->tpl_vars['USERDEPARTMENT']->value)){?><tr class="hide realremarkbutton" nowrap><td colspan="3"><textarea class="row-fluid remark" id="remarkvalue" required="required" placeholder="请输入备注信息" name="description" ></textarea></td><td colspan="2"><div class="pull-right"><button type="button" id="realremarkbutton" class="btn btn-success"><strong>保存</strong></button><a class="cancelLink" type="reset" onclick="$('.realremarkbutton').hide();">取消</a></div></td></tr><?php }?><tr><th class="detailViewBlockHeader" nowrap><img class="cursorPointer alignMiddle blockToggle hide" src="layouts/vlayout/skins/softed/images/arrowRight.png" data-mode="hide" data-id="61" style="display: none;"><img class="cursorPointer alignMiddle blockToggle " src="layouts/vlayout/skins/softed/images/arrowDown.png" data-mode="show" data-id="61">操作人</th><!--<div class="btn-group"><button type="button" class="btn stagesubmit">审核</button></div><th class="detailViewBlockHeader" nowrap>备注节点</th>--><th class="detailViewBlockHeader" width="60%">备注原因</th><th class="detailViewBlockHeader" nowrap>创建日期</th><th class="detailViewBlockHeader"nowrap>修改时间</th><th class="detailViewBlockHeader" nowrap><?php if (($_smarty_tpl->tpl_vars['ISROLE']->value&&$_smarty_tpl->tpl_vars['STAGERECORDID']->value)||in_array($_smarty_tpl->tpl_vars['USER']->value,$_smarty_tpl->tpl_vars['USERDEPARTMENT']->value)){?><div class="pull-right"><button type="button" onclick="$('.realremarkbutton').show();$('#remarkvalue').focus();" class="btn btn-info">添加备注</button>&nbsp;</div><?php }?></th></tr></thead><?php  $_smarty_tpl->tpl_vars['value'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['value']->_loop = false;
 $_smarty_tpl->tpl_vars['index'] = new Smarty_Variable;
