<?php /* Smarty version Smarty-3.1.7, created on 2022-02-16 10:13:07
         compiled from "D:\phpstudy_pro\WWW\pc_release\includes\runtime/../../layouts/vlayout\modules\Settings\Profiles\EditView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:30754620c5db3963177-72868474%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7c9ce15ffc9be4837389483c81312dffb2fb8cad' => 
    array (
      0 => 'D:\\phpstudy_pro\\WWW\\pc_release\\includes\\runtime/../../layouts/vlayout\\modules\\Settings\\Profiles\\EditView.tpl',
      1 => 1523874481,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '30754620c5db3963177-72868474',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_620c5db3a94ff',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_620c5db3a94ff')) {function content_620c5db3a94ff($_smarty_tpl) {?>
...
</th><th width="14%" style="border-left: 1px solid #DDD !important;"><!--<input <?php if (empty($_smarty_tpl->tpl_vars['RECORD_ID']->value)&&empty($_smarty_tpl->tpl_vars['IS_DUPLICATE_RECORD']->value)){?> class="alignTop"  checked="true" <?php }?> type="checkbox"  />--><?php echo vtranslate('LBL_VIEW_PRVILIGE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
&nbsp;<select  style="width:140px;" id="mainAction4CheckBox"><optgroup><?php  $_smarty_tpl->tpl_vars['value'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['value']->_loop = false;
 $_smarty_tpl->tpl_vars['index'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['ACTION_AUTH']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['value']->key => $_smarty_tpl->tpl_vars['value']->value){
$_smarty_tpl->tpl_vars['value']->_loop = true;
 $_smarty_tpl->tpl_vars['index']->value = $_smarty_tpl->tpl_vars['value']->key;
?><option value="<?php echo $_smarty_tpl->tpl_vars['index']->value;?>
" <?php if ($_smarty_tpl->tpl_vars['value']->value==$_smarty_tpl->tpl_vars['REFERENCED_MODULE_NAME']->value){?> selected <?php }?>><?php echo vtranslate($_smarty_tpl->tpl_vars['value']->value,$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
 </option><?php } ?></optgroup></select></th><th width="14%" style="border-left: 1px solid #DDD !important;"><!--<input <?php if (empty($_smarty_tpl->tpl_vars['RECORD_ID']->value)&&empty($_smarty_tpl->tpl_vars['IS_DUPLICATE_RECORD']->value)){?> class="alignTop" checked="true"<?php }?> type="checkbox"  />-->&nbsp;<?php echo vtranslate('LBL_EDIT_PRVILIGE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
<select  style="width:100px;" id="mainAction1CheckBox"><optgroup><?php  $_smarty_tpl->tpl_vars['value'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['value']->_loop = false;
 $_smarty_tpl->tpl_vars['index'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['ACTION_AUTH']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['value']->key => $_smarty_tpl->tpl_vars['value']->value){
$_smarty_tpl->tpl_vars['value']->_loop = true;
...
?><option value="<?php echo $_smarty_tpl->tpl_vars['index']->value;?>
" <?php if ($_smarty_tpl->tpl_vars['value']->value==$_smarty_tpl->tpl_vars['REFERENCED_MODULE_NAME']->value){?> selected <?php }?>><?php echo vtranslate($_smarty_tpl->tpl_vars['value']->value,$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
 </option><?php } ?></optgroup></select></th><th width="14%" style="border-left: 1px solid #DDD !important;"><!--<input checked="true" class="alignTop" type="checkbox"  />-->&nbsp;<?php echo vtranslate('LBL_DELETE_PRVILIGE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
<select  style="width:100px;" id="mainAction2CheckBox"><optgroup><?php  $_smarty_tpl->tpl_vars['value'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['value']->_loop = false;
 $_smarty_tpl->tpl_vars['index'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['ACTION_AUTH']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['value']->key => $_smarty_tpl->tpl_vars['value']->value){
$_smarty_tpl->tpl_vars['value']->_loop = true;
...
?><option value="<?php echo $_smarty_tpl->tpl_vars['index']->value;?>
" <?php if ($_smarty_tpl->tpl_vars['value']->value==$_smarty_tpl->tpl_vars['REFERENCED_MODULE_NAME']->value){?> selected <?php }?>><?php echo vtranslate($_smarty_tpl->tpl_vars['value']->value,$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
 </option><?php } ?></optgroup></select></th><th width="14%" style="border-left: 1px solid #DDD !important;"><!--<input checked="true" class="alignTop" type="checkbox"  />-->&nbsp;<?php echo vtranslate('LBL_POPUP_PRVILIGE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
<select  style="width:100px;" id="mainAction11CheckBox"><optgroup><?php  $_smarty_tpl->tpl_vars['value'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['value']->_loop = false;
 $_smarty_tpl->tpl_vars['index'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['ACTION_AUTH']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['value']->key => $_smarty_tpl->tpl_vars['value']->value){
$_smarty_tpl->tpl_vars['value']->_loop = true;
...
?><option value="<?php echo $_smarty_tpl->tpl_vars['index']->value;?>
" <?php if ($_smarty_tpl->tpl_vars['value']->value==$_smarty_tpl->tpl_vars['REFERENCED_MODULE_NAME']->value){?> selected <?php }?>><?php echo vtranslate($_smarty_tpl->tpl_vars['value']->value,$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
 </option><?php } ?></optgroup></select></th><th width="28%" style="border-left: 1px solid #DDD !important;" nowrap="nowrap"><?php echo vtranslate('LBL_FIELD_AND_TOOL_PRVILIGES',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</td><?php $_smarty_tpl->tpl_vars["BASIC_ACTION_ORDER"] = new Smarty_variable(array(4,1,2,11), null, 0);?><?php  $_smarty_tpl->tpl_vars['ORDERID'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['ORDERID']->_loop = false;
...
-unchecked="true"<?php }?>>--><?php $_smarty_tpl->tpl_vars['AUTH_VALUE'] = new Smarty_variable($_smarty_tpl->tpl_vars['PROFILE_MODULE']->value->get('permissions'), null, 0);?><select  style="width:140px;"  class="action<?php echo $_smarty_tpl->tpl_vars['ACTION_ID']->value;?>
CheckBox" name="permissions[<?php echo $_smarty_tpl->tpl_vars['TABID']->value;?>
...
" ><optgroup><?php  $_smarty_tpl->tpl_vars['value'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['value']->_loop = false;
 $_smarty_tpl->tpl_vars['index'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['ACTION_AUTH']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['value']->key => $_smarty_tpl->tpl_vars['value']->value){
$_smarty_tpl->tpl_vars['value']->_loop = true;
 $_smarty_tpl->tpl_vars['index']->value = $_smarty_tpl->tpl_vars['value']->key;
?><option value="<?php echo $_smarty_tpl->tpl_vars['index']->value;?>
" <?php if ($_smarty_tpl->tpl_vars['index']->value==$_smarty_tpl->tpl_vars['AUTH_VALUE']->value['actions'][$_smarty_tpl->tpl_vars['ACTION_ID']->value]){?> selected <?php }?>><?php echo vtranslate($_smarty_tpl->tpl_vars['value']->value,$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
 </option><?php } ?></optgroup></select><?php }?></td><?php } ?><td style="border-left: 1px solid #DDD !important;"><?php if ($_smarty_tpl->tpl_vars['PROFILE_MODULE']->value->getFields()){?><div class="row-fluid"><span class="span4">&nbsp;</span><span class="span4"><button type="button" data-handlerfor="fields" data-togglehandler="<?php echo $_smarty_tpl->tpl_vars['TABID']->value;?>
...
?><?php if ($_smarty_tpl->tpl_vars['ACTION_MODEL']->value->isModuleEnabled($_smarty_tpl->tpl_vars['PROFILE_MODULE']->value)){?><?php $_smarty_tpl->tpl_vars["testArray"] = new Smarty_variable(array_push($_smarty_tpl->tpl_vars['ALL_UTILITY_ACTIONS_ARRAY']->value,$_smarty_tpl->tpl_vars['ACTION_MODEL']->value), null, 0);?><?php }?><?php } ?><td colspan="6" class="row-fluid" style="padding-left: 5%;padding-right: 5%;background-image: none !important;"><?php if (!empty($_smarty_tpl->tpl_vars['ALL_UTILITY_ACTIONS_ARRAY']->value)){?><div class="row-fluid hide" data-togglecontent="<?php echo $_smarty_tpl->tpl_vars['TABID']->value;?>
...
</strong></label></div><table class="table table-bordered table-striped"><?php  $_smarty_tpl->tpl_vars['ACTION_MODEL'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['ACTION_MODEL']->_loop = false;
...
</td><?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['actions']['last']||($_smarty_tpl->getVariable('smarty')->value['foreach']['actions']['index']+1)%3==0){?></div><?php }?><?php } ?></table></div><?php }?></td></tr><?php }?><?php } ?></tbody></table></div></div><div class="pull-right"><button class="btn btn-success" type="submit"><?php echo vtranslate('LBL_SAVE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
