<?php /* Smarty version Smarty-3.1.7, created on 2022-02-15 11:41:23
         compiled from "D:\phpstudy_pro\WWW\pc_release\includes\runtime/../../layouts/vlayout\modules\ServiceContracts\uitypes\Reference.tpl" */ ?>
<?php /*%%SmartyHeaderCode:30208620b20e38b6f27-97224473%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7c924f3fcdda51218434adfc3f2e653b1c21edb9' => 
    array (
      0 => 'D:\\phpstudy_pro\\WWW\\pc_release\\includes\\runtime/../../layouts/vlayout\\modules\\ServiceContracts\\uitypes\\Reference.tpl',
      1 => 1630053025,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '30208620b20e38b6f27-97224473',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_620b20e391f88',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_620b20e391f88')) {function content_620b20e391f88($_smarty_tpl) {?>
...
" data-multiple="<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('ismultiple');?>
...
' style="<?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldName()=='sc_related_to'){?>margin-bottom:3px<?php }?>"  placeholder="<?php echo vtranslate('LBL_TYPE_SEARCH',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
"></i></span><?php }?>--><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldName()=='sc_related_to'){?><input id="needZizhi" name="needZizhi" type="hidden" value="no"><div class="fileUploadContainerZizhi" style="display: none" xmlns="http://www.w3.org/1999/html"><?php $_smarty_tpl->tpl_vars['FIELD_VALUE'] = new Smarty_variable(explode('*|*',$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('fieldvalue')), null, 0);?><div class="upload <?php echo $_smarty_tpl->tpl_vars['FIELD_VALUE']->value[0];?>
"><div  id="fileUploadRemand" style="display:inline-block;height:30px;overflow: hidden;vertical-align: middle;"  title="文件名请勿包含空格"><div style="margin-top:-2px;">文件名请勿</div><div style="margin-top:-5px;">包含空格</div></div><input type="button" id="uploadzizhiButton" value="上传资质"  title="文件名请勿包含空格" /><div style="display:inline-block" id="fileallzizhi"><?php if (!empty($_smarty_tpl->tpl_vars['FIELD_VALUE']->value[0])){?><?php  $_smarty_tpl->tpl_vars['NEWFILD'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['NEWFILD']->_loop = false;
...
" type="hidden" name="zizhifile[<?php echo $_smarty_tpl->tpl_vars['NFIELD_VALUE']->value[1];?>
]" data-id="<?php echo $_smarty_tpl->tpl_vars['NFIELD_VALUE']->value[1];?>
" id="zizhifile" value="<?php echo $_smarty_tpl->tpl_vars['NFIELD_VALUE']->value[0];?>
...
"><?php } ?><?php }else{ ?><input class="ke-input-text zizhifiledelete" type="hidden" name="zizhifile" id="zizhifile" value="" readonly="readonly" /><input class="zizhifiledelete" type="hidden" name="attachmentsid" value=""><?php }?></div></div></div><?php }?></div>
<?php }} ?>