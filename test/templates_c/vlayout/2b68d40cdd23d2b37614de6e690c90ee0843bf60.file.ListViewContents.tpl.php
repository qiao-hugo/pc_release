<?php /* Smarty version Smarty-3.1.7, created on 2022-02-17 09:22:54
         compiled from "D:\phpstudy_pro\WWW\pc_release\includes\runtime/../../layouts/vlayout\modules\CompayCode\ListViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6661620da36e1cf359-66455715%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2b68d40cdd23d2b37614de6e690c90ee0843bf60' => 
    array (
      0 => 'D:\\phpstudy_pro\\WWW\\pc_release\\includes\\runtime/../../layouts/vlayout\\modules\\CompayCode\\ListViewContents.tpl',
      1 => 1523874460,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6661620da36e1cf359-66455715',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_620da36e21956',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_620da36e21956')) {function content_620da36e21956($_smarty_tpl) {?>
...
"><?php echo vtranslate($_smarty_tpl->tpl_vars['KEY']->value,$_smarty_tpl->tpl_vars['MODULE']->value);?>
</th><?php } ?><?php }?><th nowrap style="width:90px">操作</th></tr></thead><?php  $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->_loop = false;
...
&view=Detail&record=<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value['id'];?>
"><i title="详细信息" class="icon-th-list alignMiddle"></i></a>&nbsp;<?php if ($_smarty_tpl->tpl_vars['IS_MODULE_EDITABLE']->value){?><a  href='index.php?module=<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
...
" class="icon-pencil alignMiddle"></i></a>&nbsp;<?php }?><?php if ($_smarty_tpl->tpl_vars['IS_MODULE_DELETABLE']->value){?><a class="deleteRecordButton"><i title="删除" class="icon-trash alignMiddle"></i></a><?php }?></div><?php }?></td></tr><?php } ?></table></div></div></div>
<?php }} ?>