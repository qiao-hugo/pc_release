<?php /* Smarty version Smarty-3.1.7, created on 2022-02-15 11:49:29
         compiled from "D:\phpstudy_pro\WWW\pc_release\includes\runtime/../../layouts/vlayout\modules\Staypayment\uitypes\Reference.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6140620b22c95db896-96850038%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ec77056e2cb3e58ebc75fc00b794af61a064238e' => 
    array (
      0 => 'D:\\phpstudy_pro\\WWW\\pc_release\\includes\\runtime/../../layouts/vlayout\\modules\\Staypayment\\uitypes\\Reference.tpl',
      1 => 1598601385,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6140620b22c95db896-96850038',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_620b22c962bdd',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_620b22c962bdd')) {function content_620b22c962bdd($_smarty_tpl) {?>
...
' /><?php $_smarty_tpl->tpl_vars["displayId"] = new Smarty_variable($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('fieldvalue'), null, 0);?><div class="row-fluid input-prepend input-append"><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldName()!='accountid'){?><span class="add-on clearReferenceSelection cursorPointer"><i id="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
_editView_fieldName_<?php echo $_smarty_tpl->tpl_vars['FIELD_NAME']->value;?>
_clear" class='icon-remove-sign' title="<?php echo vtranslate('LBL_CLEAR',$_smarty_tpl->tpl_vars['MODULE']->value);?>
"></i></span><?php }?><input id="<?php echo $_smarty_tpl->tpl_vars['FIELD_NAME']->value;?>
...
'<?php }?><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldName()=='accountid'){?>readonly placeholder=""<?php }else{ ?>placeholder="<?php echo vtranslate('LBL_TYPE_SEARCH',$_smarty_tpl->tpl_vars['MODULE']->value);?>
"<?php }?>/><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldName()!='accountid'){?><span class="add-on relatedPopup cursorPointer"><i id="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
_editView_fieldName_<?php echo $_smarty_tpl->tpl_vars['FIELD_NAME']->value;?>
_select" class="icon-search relatedPopup" title="<?php echo vtranslate('LBL_SELECT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
" ></i></span><?php }?><?php $_smarty_tpl->tpl_vars['QUICKCREATE_RESTRICTED_MODULES'] = new Smarty_variable(array('SalesOrder','Quotes','Invoice','PurchaseOrder'), null, 0);?><!-- Show the add button only if it is edit view<?php if ($_REQUEST['view']=='Edit'&&!in_array($_smarty_tpl->tpl_vars['REFERENCE_LIST']->value[0],$_smarty_tpl->tpl_vars['QUICKCREATE_RESTRICTED_MODULES']->value)){?><span class="add-on cursorPointer createReferenceRecord"><i id="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
_editView_fieldName_<?php echo $_smarty_tpl->tpl_vars['FIELD_NAME']->value;?>
