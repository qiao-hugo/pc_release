<?php /* Smarty version Smarty-3.1.7, created on 2022-02-16 15:04:24
         compiled from "D:\phpstudy_pro\WWW\pc_release\includes\runtime/../../layouts/vlayout\modules\Settings\Profiles\DetailView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2384620ca1f8a1a4b3-71238680%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '65dbd20172e2e15c353b9ac1c048053cf3ff8ff5' => 
    array (
      0 => 'D:\\phpstudy_pro\\WWW\\pc_release\\includes\\runtime/../../layouts/vlayout\\modules\\Settings\\Profiles\\DetailView.tpl',
      1 => 1523874481,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2384620ca1f8a1a4b3-71238680',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_620ca1f8aec56',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_620ca1f8aec56')) {function content_620ca1f8aec56($_smarty_tpl) {?>
...
</span></th><th width="11%" style="border-left: 1px solid #DDD !important;"><span class="horizontalAlignCenter" ><?php echo vtranslate('LBL_POPUP_PRVILIGE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</td><?php $_smarty_tpl->tpl_vars["BASIC_ACTION_ORDER"] = new Smarty_variable(array(4,1,2,11), null, 0);?><?php $_smarty_tpl->tpl_vars["ACTION_PERMISSION"] = new Smarty_variable($_smarty_tpl->tpl_vars['PROFILE_MODULE']->value->permissions, null, 0);?><?php  $_smarty_tpl->tpl_vars['ACTION_ID'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['ACTION_ID']->_loop = false;
...
?><td style="border-left: 1px solid #DDD !important;"><?php $_smarty_tpl->tpl_vars["ACTION_MODEL"] = new Smarty_variable($_smarty_tpl->tpl_vars['ALL_BASIC_ACTIONS']->value[$_smarty_tpl->tpl_vars['ACTION_ID']->value], null, 0);?><?php if (!$_smarty_tpl->tpl_vars['IS_RESTRICTED_MODULE']->value&&$_smarty_tpl->tpl_vars['ACTION_MODEL']->value->isModuleEnabled($_smarty_tpl->tpl_vars['PROFILE_MODULE']->value)){?><?php $_smarty_tpl->tpl_vars["PERMISSION_VALUE"] = new Smarty_variable($_smarty_tpl->tpl_vars['PERMISSION_LIST']->value[$_smarty_tpl->tpl_vars['ACTION_PERMISSION']->value['actions'][$_smarty_tpl->tpl_vars['ACTION_ID']->value]], null, 0);?><?php echo vtranslate($_smarty_tpl->tpl_vars['PERMISSION_VALUE']->value,$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
<?php }?></td><?php } ?><td style="border-left: 1px solid #DDD !important;"><?php if ($_smarty_tpl->tpl_vars['PROFILE_MODULE']->value->getFields()){?><div class="row-fluid"><span class="span4">&nbsp;</span><span class="span4"><button type="button" data-handlerfor="fields" data-togglehandler="<?php echo $_smarty_tpl->tpl_vars['TABID']->value;?>
