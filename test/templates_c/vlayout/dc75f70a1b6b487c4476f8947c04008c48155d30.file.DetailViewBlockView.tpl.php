<?php /* Smarty version Smarty-3.1.7, created on 2022-02-15 09:23:33
         compiled from "D:\phpstudy_pro\WWW\pc_release\includes\runtime/../../layouts/vlayout\modules\Accounts\DetailViewBlockView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10617620b00953affc7-61157011%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dc75f70a1b6b487c4476f8947c04008c48155d30' => 
    array (
      0 => 'D:\\phpstudy_pro\\WWW\\pc_release\\includes\\runtime/../../layouts/vlayout\\modules\\Accounts\\DetailViewBlockView.tpl',
      1 => 1561711755,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10617620b00953affc7-61157011',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_620b00954fadf',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_620b00954fadf')) {function content_620b00954fadf($_smarty_tpl) {?>
...
?><?php if (!$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isViewableInDetailView()||$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getName()=='workflowsid'){?><?php continue 1?><?php }?><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')=="83"){?><?php  $_smarty_tpl->tpl_vars['tax'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['tax']->_loop = false;
...
</span><?php $_smarty_tpl->tpl_vars['AJAX_EDIT'] = new Smarty_variable(array('linkname','makedecisiontype','gendertype','email1','title','phone'), null, 0);?><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isEditable()=='true'&&($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldDataType()!=Vtiger_Field_Model::REFERENCE_TYPE)&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isAjaxEditable()=='true'&&in_array($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name'),$_smarty_tpl->tpl_vars['AJAX_EDIT']->value)){?><span class="hide edit"><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getUITypeModel()->getTemplateName(),$_smarty_tpl->tpl_vars['MODULE_NAME']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('FIELD_MODEL'=>$_smarty_tpl->tpl_vars['FIELD_MODEL']->value,'USER_MODEL'=>$_smarty_tpl->tpl_vars['USER_MODEL']->value,'MODULE'=>$_smarty_tpl->tpl_vars['MODULE_NAME']->value), 0);?>
...
"></td><td class="<?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"></td><?php }?><?php } ?></tr></tbody></table><br><?php } ?><div class="widgetContainer_servicecontract" data-url="module=ServiceContracts&view=Detail&mode=getProducts&amp;record=<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->getId();?>
" data-name="Workflows"><div class="widget_contents"></div></div>
	<script>
        //保存后直接查看详情   然后把教育的子内容拼接在教育栏
        if($.trim($("#_detailView_fieldValue_educationproperty").text()).length>0){
            $("#_detailView_fieldValue_industry").text($("#_detailView_fieldValue_industry").text()+">"+$("#_detailView_fieldValue_educationproperty").text());
        }
        $("#_detailView_fieldValue_educationproperty").text("");
        $("#_detailView_fieldLabel_educationproperty").text("");
	</script>
<?php }} ?>