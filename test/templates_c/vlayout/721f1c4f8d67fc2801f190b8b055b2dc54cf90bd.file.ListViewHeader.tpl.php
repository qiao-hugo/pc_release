<?php /* Smarty version Smarty-3.1.7, created on 2022-02-15 16:37:33
         compiled from "D:\phpstudy_pro\WWW\pc_release\includes\runtime/../../layouts/vlayout\modules\Leads\ListViewHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15914620b664dc465e8-70073959%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '721f1c4f8d67fc2801f190b8b055b2dc54cf90bd' => 
    array (
      0 => 'D:\\phpstudy_pro\\WWW\\pc_release\\includes\\runtime/../../layouts/vlayout\\modules\\Leads\\ListViewHeader.tpl',
      1 => 1639627447,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15914620b664dc465e8-70073959',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_620b664dd8dcb',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_620b664dd8dcb')) {function content_620b664dd8dcb($_smarty_tpl) {?>
<?php $_smarty_tpl->tpl_vars["NO_ACTION_NAME"] = new Smarty_variable(array('accountSearch','accountDeal','leadaccountdeal','leadsetting','leadbatch','cluesharing','assignpersonal'), null, 0);?><div class="listViewPageDiv"><?php if (!in_array($_GET['filter'],$_smarty_tpl->tpl_vars['NO_ACTION_NAME']->value)){?><div class="listViewTopMenuDiv noprint"><div class="listViewActionsDiv row-fluid"><span class="btn-toolbar span4"><span class="<?php if (empty($_GET['public'])==false){?>hide<?php }?>"><?php  $_smarty_tpl->tpl_vars['LISTVIEW_BASICACTION'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['LISTVIEW_BASICACTION']->_loop = false;
