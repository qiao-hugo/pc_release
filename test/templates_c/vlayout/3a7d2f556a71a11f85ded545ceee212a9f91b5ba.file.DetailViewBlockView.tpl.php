<?php /* Smarty version Smarty-3.1.7, created on 2022-02-17 09:24:12
         compiled from "D:\phpstudy_pro\WWW\pc_release\includes\runtime/../../layouts/vlayout\modules\Vtiger\DetailViewBlockView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4853620da3bc3b51a2-15105698%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3a7d2f556a71a11f85ded545ceee212a9f91b5ba' => 
    array (
      0 => 'D:\\phpstudy_pro\\WWW\\pc_release\\includes\\runtime/../../layouts/vlayout\\modules\\Vtiger\\DetailViewBlockView.tpl',
      1 => 1523874473,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4853620da3bc3b51a2-15105698',
  'function' => 
  array (
  ),
  'variables' => 
  array (
    ...
    'followdata' => 0,
    'da' => 0,
    'ACHIEVEMENTALLOTDATA' => 0,
    'BLOCK_FIELDS' => 0,
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_620da3bc5b1f5',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_620da3bc5b1f5')) {function content_620da3bc5b1f5($_smarty_tpl) {?>
...
<?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->name=='probability'){?>%<?php }?></span></td><?php }?><?php if (count($_smarty_tpl->tpl_vars['FIELD_MODEL_LIST']->value)==1&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="19"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="20"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="30"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name')!="recurringtype"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="69"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="105"){?><td class="<?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"></td><td class="<?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"></td><?php }?><?php } ?></tr></tbody></table><?php } ?><?php if (count($_smarty_tpl->tpl_vars['followdata']->value)!=0){?><table class="table table-bordered equalSplit detailview-table"><thead><th class="blockHeader" colspan="2"><img class="cursorPointer alignMiddle blockToggle  hide  " src="layouts/vlayout/skins/softed/images/arrowRight.png" data-mode="hide" data-id="144"><img class="cursorPointer alignMiddle blockToggle " src="layouts/vlayout/skins/softed/images/arrowDown.png" data-mode="show" data-id="144">&nbsp;&nbsp;跟进详细</th></thead><tr><td>跟进状态</td><td>跟进时间</td></tr><tr><?php  $_smarty_tpl->tpl_vars['da'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['da']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['followdata']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['da']->key => $_smarty_tpl->tpl_vars['da']->value){
$_smarty_tpl->tpl_vars['da']->_loop = true;
?><td><?php echo $_smarty_tpl->tpl_vars['da']->value;?>
</td><?php } ?></tr></table><?php }?><?php if ($_smarty_tpl->tpl_vars['ACHIEVEMENTALLOTDATA']->value!=''){?><table class="table table-bordered blockContainer showInlineTable" id="achievementallottable"><tr><thead><th class="blockHeader" colspan="6"><span>回款业绩分配</span></th></thead></tr><?php  $_smarty_tpl->tpl_vars['BLOCK_FIELDS'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['BLOCK_FIELDS']->_loop = false;
 $_smarty_tpl->tpl_vars['BLOCK_LABEL'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['ACHIEVEMENTALLOTDATA']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']["EditViewBlockLevelLoop"]['index']=-1;
foreach ($_from as $_smarty_tpl->tpl_vars['BLOCK_FIELDS']->key => $_smarty_tpl->tpl_vars['BLOCK_FIELDS']->value){
$_smarty_tpl->tpl_vars['BLOCK_FIELDS']->_loop = true;
 $_smarty_tpl->tpl_vars['BLOCK_LABEL']->value = $_smarty_tpl->tpl_vars['BLOCK_FIELDS']->key;
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']["EditViewBlockLevelLoop"]['index']++;
?><tr><td><label class="muted pull-right marginRight10px">业绩所属人</label></td><td> <input type='hidden' name="achievementallotdata[<?php echo $_smarty_tpl->getVariable('smarty')->value['foreach']['EditViewBlockLevelLoop']['index'];?>
][]" value="<?php echo $_smarty_tpl->tpl_vars['BLOCK_FIELDS']->value['receivedpaymentownid'];?>
"><?php echo $_smarty_tpl->tpl_vars['BLOCK_FIELDS']->value['receivedpaymentownid'];?>
</td><td><label class="muted pull-right marginRight10px">事业部</label></td><td> <input type='hidden' name="achievementallotdata[<?php echo $_smarty_tpl->getVariable('smarty')->value['foreach']['EditViewBlockLevelLoop']['index'];?>
][]" value="<?php echo $_smarty_tpl->tpl_vars['BLOCK_FIELDS']->value['businessunit'];?>
"><?php echo $_smarty_tpl->tpl_vars['BLOCK_FIELDS']->value['businessunit'];?>
</td><td><label class="muted pull-right marginRight10px">所属公司</label></td><td> <input type='hidden' name="achievementallotdata[<?php echo $_smarty_tpl->getVariable('smarty')->value['foreach']['EditViewBlockLevelLoop']['index'];?>
][]" value="<?php echo $_smarty_tpl->tpl_vars['BLOCK_FIELDS']->value['owncompanys'];?>
"><?php echo $_smarty_tpl->tpl_vars['BLOCK_FIELDS']->value['owncompanys'];?>
