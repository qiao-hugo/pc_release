  ...
  */
  ...
  AbstractChosen = (function() {
    function AbstractChosen(form_field, options) {
      ...
      this.default_text_default = this.is_multiple ? "选择多个选项" : "选择一个选项";
      this.setup();
      this.set_up_html();
    ...
    AbstractChosen.prototype.set_default_values = function() {
      ...
      this.choices = 0;
      return this.results_none_found = this.options.no_results_text || "没有结果匹配";
    };
    ...
    AbstractChosen.prototype.result_add_option = function(option) {
      ...
      if (!option.disabled) {
        ...
        return '<li id="' + option.dom_id + '" class="' + classes.join(' ') + '" title="'+option.title+'" ' + style + '>' + option.html + '</li>';
      } else {
        return "";
      }
    };
