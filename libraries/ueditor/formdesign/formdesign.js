...
*UE.getEditor('myFormDesign',{toolleipi:true,//是否显示，设计器的清单 tool
*/
UE.FormDesignUrl = window.UEDITOR_CONFIG.UEDITOR_HOME_URL+'formdesign';
/**
 * 文本框
 * @command textfield
 * @method execCommand
...
UE.plugins['text'] = function () {
	...
	me.commands[thePlugins] = {
		execCommand:function () {
			var dialog = new UE.ui.Dialog({
				iframeUrl: UE.FormDesignUrl+'/text.html',
				name:thePlugins,
				editor:this,
				title: '文本框',
	...
	me.addListener( 'mouseover', function( t, evt ) {
        ...
        var elePlugins = el.getAttribute('plugintype');
		if ( /span/ig.test( el.tagName ) && elePlugins==thePlugins) {
...
UE.plugins['macros'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: UE.FormDesignUrl+'/macros.html',
                name:thePlugins,
                editor:this,
                title: '宏控件',
    ...
    me.addListener( 'mouseover', function( t, evt ) {
        ...
        var el = evt.target || evt.srcElement;
        var elePlugins = el.getAttribute('plugintype');
        if ( /input/ig.test( el.tagName ) && elePlugins==thePlugins) {
            var html = popup.formatHtml(
...
UE.plugins['radio'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: UE.FormDesignUrl+'/radio.html',
                name:thePlugins,
                editor:this,
                title: '单选框',
...
UE.plugins['checkbox'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: UE.FormDesignUrl+'/checkbox.html',
                name:thePlugins,
                editor:this,
                title: '复选框',
...
UE.plugins['radios'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: UE.FormDesignUrl+'/radios.html',
                name:thePlugins,
                editor:this,
                title: '单选框组',
                cssRules:"width:590px;height:370px;",
...
UE.plugins['checkboxs'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: UE.FormDesignUrl+'/checkboxs.html',
                name:thePlugins,
                editor:this,
                title: '复选框组',
...
UE.plugins['textarea'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: UE.FormDesignUrl+'/textarea.html',
                name:thePlugins,
                editor:this,
                title: '多行文本框',
...
UE.plugins['select'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: UE.FormDesignUrl+'/select.html',
                name:thePlugins,
                editor:this,
                title: '下拉菜单',
                cssRules:"width:590px;height:370px;",
...
UE.plugins['progressbar'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: UE.FormDesignUrl+'/progressbar.html',
                name:thePlugins,
                editor:this,
                title: '进度条',
    ...
    me.addListener( 'mouseover', function( t, evt ) {
        ...
        var el = evt.target || evt.srcElement;
        var elePlugins = el.getAttribute('plugintype');
        if ( /img/ig.test( el.tagName ) && elePlugins==thePlugins) {
            var html = popup.formatHtml(
...
UE.plugins['qrcode'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: UE.FormDesignUrl+'/qrcode.html',
                name:thePlugins,
                editor:this,
                title: '二维码',
...
UE.plugins['listctrl'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: UE.FormDesignUrl+'/listctrl.html',
                name:thePlugins,
                editor:this,
                title: '列表控件',
...
UE.plugins['more'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: UE.FormDesignUrl+'/more.html',
                name:thePlugins,
                editor:this,
...
UE.plugins['error'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: UE.FormDesignUrl+'/error.html',
                name:thePlugins,
                editor:this,
                title: '异常提示',
...
UE.plugins['leipi'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: UE.FormDesignUrl+'/leipi.html',
                name:thePlugins,
                editor:this,
                title: '表单设计器 - 清单',
...
UE.plugins['leipi_template'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: UE.FormDesignUrl+'/template.html',
                name:thePlugins,
                editor:this,
                title: '表单模板',
